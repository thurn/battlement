...
use crate::arcade::{assets, frame_styles, screen_frame};
use battlement::{
  ...
  View::new()
    ...
    .style(
      Style::new()
        ...
        .width(crate::arcade::portrait_viewport::PORTRAIT_DESIGN_WIDTH)
        .height(crate::arcade::portrait_viewport::PORTRAIT_DESIGN_HEIGHT)
