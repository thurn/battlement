...
use crate::arcade::music_heartbeat::{self, Heartbeat};
...
pub struct BackgroundMusicProvider {
  ...
  autoplay: bool,
  /// Silences the menu track while the chess board is active.
  active: bool,
}
...
impl Component for BackgroundMusicProvider {
  fn render(&self) -> impl Render {
    let context = use_background_music_provider(self.autoplay, self.active);
    ContextProvider::new()
      .context(context)
