...
use crate::menu::{assets, frame_styles, screen_frame};
use battlement::{
  ...
  View::new()
    ...
    .style(
      Style::new()
        ...
        .width(crate::menu::portrait_viewport::PORTRAIT_DESIGN_WIDTH)
        .height(crate::menu::portrait_viewport::PORTRAIT_DESIGN_HEIGHT)
