...
use crate::menu::use_interaction::InteractionState;
use crate::menu::{
            ...
            .child((
              self.artwork.map(|artwork| {
                let asset = match artwork {
                  ...
                  ActionLabel::About => assets::ACTION_LABEL_ABOUT,
                  ActionLabel::Quit => assets::ACTION_LABEL_QUIT,
                  ActionLabel::Return => assets::ACTION_LABEL_RETURN,
                };
                asset
                  .image()
