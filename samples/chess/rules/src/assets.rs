...
use battlement::{MaterialAddress, PrefabAddress, SceneAddress, TextureAddress};

/// Addressable key `board` (UnityEngine.GameObject) from `Assets/ThirdParty/KayKit/board_A.fbx` in group `Battlement Chess`.
pub const BOARD: PrefabAddress = PrefabAddress::from_static("board");
