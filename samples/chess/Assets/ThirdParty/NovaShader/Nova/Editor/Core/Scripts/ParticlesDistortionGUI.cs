...
namespace Nova.Editor.Core.Scripts
{
    ...
    internal sealed class ParticlesDistortionGUI : ParticlesGUI
    {
        ...
        {
            using (
                var foldoutScope = new MaterialEditorUtility.FoldoutHeaderScope(
                    RenderSettingsFoldout.Value,
                    "Render Settings"
                )
            )
            {
        ...
        private void DrawRenderSettingsProperties(
        ...
        {
            MaterialEditorUtility.DrawTexture<CustomCoord>(
                editor,
                _baseMapProp.Value,
                _baseMapOffsetXCoordProp.Value,
                _baseMapOffsetYCoordProp.Value,
                _baseMapChannelsXProp.Value,
                _baseMapChannelsYProp.Value
            );

            MaterialEditorUtility.DrawEnumProperty<DistortionIntensityMode>(
                editor,
                "Intensity Mode",
                _distortionIntensityModeProp.Value
            );
            var intensityMode = (DistortionIntensityMode)
                _distortionIntensityModeProp.Value.floatValue;
            using (new EditorGUI.IndentLevelScope())
            {
                if (intensityMode == DistortionIntensityMode.Single)
                {
                    MaterialEditorUtility.DrawPropertyAndCustomCoord<CustomCoord>(
                        editor,
                        "Intensity",
                        _distortionIntensityProp.Value,
                        _distortionIntensityCoordProp.Value
                    );
                }
                else
                {
                    MaterialEditorUtility.DrawPropertyAndCustomCoord<CustomCoord>(
                        editor,
                        "Intensity X",
                        _distortionIntensityXProp.Value,
                        _distortionIntensityXCoordProp.Value
                    );
                    MaterialEditorUtility.DrawPropertyAndCustomCoord<CustomCoord>(
                        editor,
                        "Intensity Y",
                        _distortionIntensityYProp.Value,
                        _distortionIntensityYCoordProp.Value
                    );
                }
            }
            ...
            MaterialEditorUtility.DrawPropertyAndCustomCoord<CustomCoord>(
                editor,
                "Rotation",
                _baseMapRotationProp.Value,
                _baseMapRotationCoordProp.Value
            );
            using (new EditorGUI.IndentLevelScope())
            {
                MaterialEditorUtility.DrawVector2Property(
                    editor,
                    "Offset",
                    _baseMapRotationOffsetsProp.Value
                );
            }
            ...
            MaterialEditorUtility.DrawToggleProperty(
                editor,
                "Mirror Sampling",
                _baseMapMirrorSamplingProp.Value
            );
            MaterialEditorUtility.DrawToggleProperty(
                editor,
                "Use As Normal Map",
                _baseMapUnpackNormalProp.Value
            );
        }
        ...
        private void DrawFlowMapProperties(MaterialEditor editor, MaterialProperty[] properties)
        {
            MaterialEditorUtility.DrawTexture<CustomCoord>(
                editor,
                _flowMapProp.Value,
                _flowMapOffsetXCoordProp.Value,
                _flowMapOffsetYCoordProp.Value,
                _flowMapChannelsXProp.Value,
                _flowMapChannelsYProp.Value
            );
            MaterialEditorUtility.DrawPropertyAndCustomCoord<CustomCoord>(
                editor,
                "Rotation",
                _flowMapRotationProp.Value,
                _flowMapRotationCoordProp.Value
            );
            using (new EditorGUI.IndentLevelScope())
            {
                MaterialEditorUtility.DrawVector2Property(
                    editor,
                    "Offset",
                    _flowMapRotationOffsetsProp.Value
                );
            }
            MaterialEditorUtility.DrawPropertyAndCustomCoord<CustomCoord>(
                editor,
                "Intensity",
                _flowIntensityProp.Value,
                _flowIntensityCoordProp.Value
            );
            MaterialEditorUtility.DrawEnumFlagsProperty<FlowMapTargetDistortion>(
                editor,
                "Targets",
        ...
        private void DrawAlphaTransitionProperties(
            MaterialEditor editor,
            MaterialProperty[] properties
        )
        {
            ...
            if (mode != AlphaTransitionMode.None)
            {
                MaterialEditorUtility.DrawTexture<CustomCoord>(
                    editor,
                    _alphaTransitionMapProp.Value,
                    _alphaTransitionMapOffsetXCoordProp.Value,
                    _alphaTransitionMapOffsetYCoordProp.Value,
                    _alphaTransitionMapChannelsXProp.Value,
                    null
                );
                MaterialEditorUtility.DrawPropertyAndCustomCoord<CustomCoord>(
                    editor,
                    "Rotation",
                    _alphaTransitionMapRotationProp.Value,
                    _alphaTransitionMapRotationCoordProp.Value
                );
                using (new EditorGUI.IndentLevelScope())
                {
                    MaterialEditorUtility.DrawVector2Property(
                        editor,
                        "Offset",
                        _alphaTransitionMapRotationOffsetsProp.Value
                    );
                }
                ...
                MaterialEditorUtility.DrawPropertyAndCustomCoord<CustomCoord>(
                    editor,
                    "Progress",
                    _alphaTransitionProgressProp.Value,
                    _alphaTransitionProgressCoordProp.Value
                );
        ...
        private void DrawTransparencyProperties(
            MaterialEditor editor,
            MaterialProperty[] properties
        )
        {
            MaterialEditorUtility.DrawToggleProperty(
                editor,
                "Soft Particles",
                _softParticlesEnabledProp.Value
            );
            ...
            if (softParticlesEnabled)
                ...
                using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
                {
                    ...
                    if (changeCheckScope.changed)
                        _softParticlesIntensityProp.Value.floatValue = Mathf.Max(
                            0,
            ...
            if (depthFadeEnabled)
                ...
                using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
                {
                    MaterialEditorUtility.DrawTwoFloatProperties(
                        "Distance",
                        _depthFadeNearProp.Value,
                        "Near",
                        _depthFadeFarProp.Value,
                        "Far",
                        editor
                    );
        ...
        private readonly Property _baseMapRotationCoordProp = new(
            PropertyNames.BaseMapRotationCoord
        );
        private readonly Property _baseMapRotationOffsetsProp = new(
            PropertyNames.BaseMapRotationOffsets
        );
        private readonly Property _baseMapMirrorSamplingProp = new(
            PropertyNames.BaseMapMirrorSampling
        );
        private readonly Property _baseMapUnpackNormalProp = new(PropertyNames.BaseMapUnpackNormal);
        private readonly Property _distortionIntensityModeProp = new(
            PropertyNames.DistortionIntensityMode
        );
        private readonly Property _distortionIntensityProp = new(PropertyNames.DistortionIntensity);
        private readonly Property _distortionIntensityCoordProp = new(
            PropertyNames.DistortionIntensityCoord
        );
        private readonly Property _distortionIntensityXProp = new(
            PropertyNames.DistortionIntensityX
        );
        private readonly Property _distortionIntensityXCoordProp = new(
            PropertyNames.DistortionIntensityXCoord
        );
        private readonly Property _distortionIntensityYProp = new(
            PropertyNames.DistortionIntensityY
        );
        private readonly Property _distortionIntensityYCoordProp = new(
            PropertyNames.DistortionIntensityYCoord
        );
        ...
        private readonly Property _flowMapRotationCoordProp = new(
            PropertyNames.FlowMapRotationCoord
        );
        private readonly Property _flowMapRotationOffsetsProp = new(
            PropertyNames.FlowMapRotationOffsets
        );
        ...
        private readonly Property _alphaTransitionMapOffsetXCoordProp = new(
            PropertyNames.AlphaTransitionMapOffsetXCoord
        );

        private readonly Property _alphaTransitionMapOffsetYCoordProp = new(
            PropertyNames.AlphaTransitionMapOffsetYCoord
        );

        private readonly Property _alphaTransitionMapChannelsXProp = new(
            PropertyNames.AlphaTransitionMapChannelsX
        );

        private readonly Property _alphaTransitionProgressProp = new(
            PropertyNames.AlphaTransitionProgress
        );

        private readonly Property _alphaTransitionProgressCoordProp = new(
        ...
        private readonly Property _alphaTransitionMapRotationProp = new(
            PropertyNames.AlphaTransitionMapRotation
        );
        private readonly Property _alphaTransitionMapRotationCoordProp = new(
            PropertyNames.AlphaTransitionMapRotationCoord
        );
        private readonly Property _alphaTransitionMapRotationOffsetsProp = new(
            PropertyNames.AlphaTransitionMapRotationOffsets
        );
        ...
        private readonly Property _softParticlesEnabledProp = new(
            PropertyNames.SoftParticlesEnabled
        );
        private readonly Property _softParticlesIntensityProp = new(
