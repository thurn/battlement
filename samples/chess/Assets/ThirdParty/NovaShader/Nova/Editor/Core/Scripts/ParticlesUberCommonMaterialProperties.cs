...
namespace Nova.Editor.Core.Scripts
{
    internal class ParticlesUberCommonMaterialProperties
    {
        public ParticlesUberCommonMaterialProperties(MaterialProperty[] properties)
        {
            ...
            VertexDeformationFoldout = new BoolEditorPrefsProperty(
                vertexDeformationFoldoutKey,
                true
            );
        ...
        public ParticlesGUI.Property TransparentBlendModeProp { get; } =
            new(PropertyNames.TransparentBlendMode);
        ...
        public ParticlesGUI.Property VertexAlphaModeProp { get; } =
            new(PropertyNames.VertexAlphaMode);
        ...
        public ParticlesGUI.Property ZWriteOverrideProp { get; } =
            new(PropertyNames.ZWriteOverride);
        ...
        public ParticlesGUI.Property BaseMap2DArrayProp { get; } =
            new(PropertyNames.BaseMap2DArray);
        ...
        public ParticlesGUI.Property BaseMapOffsetXCoordProp { get; } =
            new(PropertyNames.BaseMapOffsetXCoord);

        public ParticlesGUI.Property BaseMapOffsetYCoordProp { get; } =
            new(PropertyNames.BaseMapOffsetYCoord);

        public ParticlesGUI.Property BaseMapRotationProp { get; } =
            new(PropertyNames.BaseMapRotation);

        public ParticlesGUI.Property BaseMapRotationCoordProp { get; } =
            new(PropertyNames.BaseMapRotationCoord);

        public ParticlesGUI.Property BaseMapRotationOffsetsProp { get; } =
            new(PropertyNames.BaseMapRotationOffsets);

        public ParticlesGUI.Property BaseMapMirrorSamplingProp { get; } =
            new(PropertyNames.BaseMapMirrorSampling);

        public ParticlesGUI.Property BaseMapChannelProp { get; } =
            new(PropertyNames.BaseMapChannel);

        // Base Map Random Row Selection
        public ParticlesGUI.Property BaseMapRandomRowSelectionEnabledProp { get; } =
            new(PropertyNames.BaseMapRandomRowSelectionEnabled);
        public ParticlesGUI.Property BaseMapRandomRowCoordProp { get; } =
            new(PropertyNames.BaseMapRandomRowCoord);
        public ParticlesGUI.Property BaseMapRowCountProp { get; } =
            new(PropertyNames.BaseMapRowCount);

        // Base Map Tri Tone
        // Base Map Tone Mode
        public ParticlesGUI.Property BaseMapToneModeProp { get; } =
            new(PropertyNames.BaseMapToneMode);
        public ParticlesGUI.Property BaseMapToneChannelProp { get; } =
            new(PropertyNames.BaseMapToneChannel);

        // Base Map Tone - Common properties
        public ParticlesGUI.Property ToneHighlightsColorProp { get; } =
            new(PropertyNames.BaseMapToneHighlightsColor);
        public ParticlesGUI.Property ToneMidtonesColorProp { get; } =
            new(PropertyNames.BaseMapToneMidtonesColor);
        public ParticlesGUI.Property ToneShadowsColorProp { get; } =
            new(PropertyNames.BaseMapToneShadowsColor);
        public ParticlesGUI.Property ToneHighlightsProp { get; } =
            new(PropertyNames.BaseMapToneHighlights);
        public ParticlesGUI.Property ToneMidtonesProp { get; } =
            new(PropertyNames.BaseMapToneMidtones);
        public ParticlesGUI.Property ToneShadowsProp { get; } =
            new(PropertyNames.BaseMapToneShadows);
        public ParticlesGUI.Property ToneHighlightsCoordProp { get; } =
            new(PropertyNames.BaseMapToneHighlightsCoord);
        public ParticlesGUI.Property ToneMidtonesCoordProp { get; } =
            new(PropertyNames.BaseMapToneMidtonesCoord);
        public ParticlesGUI.Property ToneShadowsCoordProp { get; } =
            new(PropertyNames.BaseMapToneShadowsCoord);

        // Base Map Tone - Pentone exclusive
        public ParticlesGUI.Property ToneBrightsColorProp { get; } =
            new(PropertyNames.BaseMapToneBrightsColor);
        public ParticlesGUI.Property ToneDarktonesColorProp { get; } =
            new(PropertyNames.BaseMapToneDarktonesColor);
        public ParticlesGUI.Property ToneBrightsProp { get; } =
            new(PropertyNames.BaseMapToneBrights);
        public ParticlesGUI.Property ToneDarktonesProp { get; } =
            new(PropertyNames.BaseMapToneDarktones);
        public ParticlesGUI.Property ToneBrightsCoordProp { get; } =
            new(PropertyNames.BaseMapToneBrightsCoord);
        public ParticlesGUI.Property ToneDarktonesCoordProp { get; } =
            new(PropertyNames.BaseMapToneDarktonesCoord);
        ...
        public ParticlesGUI.Property TintMap2DArrayProp { get; } =
            new(PropertyNames.TintMap2DArray);

        public ParticlesGUI.Property TintMap3DProgressProp { get; } =
            new(PropertyNames.TintMap3DProgress);

        public ParticlesGUI.Property TintMap3DProgressCoordProp { get; } =
            new(PropertyNames.TintMap3DProgressCoord);

        public ParticlesGUI.Property TintMapProgressProp { get; } =
            new(PropertyNames.TintMapProgress);

        public ParticlesGUI.Property TintMapProgressCoordProp { get; } =
            new(PropertyNames.TintMapProgressCoord);

        public ParticlesGUI.Property TintMapSliceCountProp { get; } =
            new(PropertyNames.TintMapSliceCount);

        public ParticlesGUI.Property TintMapOffsetXCoordProp { get; } =
            new(PropertyNames.TintMapOffsetXCoord);

        public ParticlesGUI.Property TintMapOffsetYCoordProp { get; } =
            new(PropertyNames.TintMapOffsetYCoord);

        public ParticlesGUI.Property TintMapBlendRateProp { get; } =
            new(PropertyNames.TintMapBlendRate);

        public ParticlesGUI.Property TintMapBlendRateCoordProp { get; } =
            new(PropertyNames.TintMapBlendRateCoord);

        public ParticlesGUI.Property TintRimProgressProp { get; } =
            new(PropertyNames.TintRimProgress);

        public ParticlesGUI.Property TintRimProgressCoordProp { get; } =
            new(PropertyNames.TintRimProgressCoord);

        public ParticlesGUI.Property TintRimSharpnessProp { get; } =
            new(PropertyNames.TintRimSharpness);

        public ParticlesGUI.Property TintRimSharpnessCoordProp { get; } =
            new(PropertyNames.TintRimSharpnessCoord);

        public ParticlesGUI.Property InverseTintRimProp { get; } =
            new(PropertyNames.InverseTintRim);

        // Tint Color Random Row Selection
        public ParticlesGUI.Property TintMapRandomRowSelectionEnabledProp { get; } =
            new(PropertyNames.TintMapRandomRowSelectionEnabled);
        public ParticlesGUI.Property TintMapRandomRowCoordProp { get; } =
            new(PropertyNames.TintMapRandomRowCoord);
        public ParticlesGUI.Property TintMapRowCountProp { get; } =
            new(PropertyNames.TintMapRowCount);

        // Tint Map Rotation
        public ParticlesGUI.Property TintMapRotationProp { get; } =
            new(PropertyNames.TintMapRotation);
        public ParticlesGUI.Property TintMapRotationCoordProp { get; } =
            new(PropertyNames.TintMapRotationCoord);
        public ParticlesGUI.Property TintMapRotationOffsetsProp { get; } =
            new(PropertyNames.TintMapRotationOffsets);
        ...
        public ParticlesGUI.Property FlowIntensityCoordProp { get; } =
            new(PropertyNames.FlowIntensityCoord);

        public ParticlesGUI.Property FlowMapTargetProp { get; } = new(PropertyNames.FlowMapTarget);

        // Flow Map Rotation
        public ParticlesGUI.Property FlowMapRotationProp { get; } =
            new(PropertyNames.FlowMapRotation);
        public ParticlesGUI.Property FlowMapRotationCoordProp { get; } =
            new(PropertyNames.FlowMapRotationCoord);
        public ParticlesGUI.Property FlowMapRotationOffsetsProp { get; } =
            new(PropertyNames.FlowMapRotationOffsets);

        #endregion

        #region Paralax Map Material Properties

        public ParticlesGUI.Property ParallaxMapModeProp { get; } =
            new(PropertyNames.ParallaxMapMode);
        public ParticlesGUI.Property ParallaxMapProp { get; } = new(PropertyNames.ParallaxMap);
        public ParticlesGUI.Property ParallaxMap2DArrayProp { get; } =
            new(PropertyNames.ParallaxMap2DArray);
        public ParticlesGUI.Property ParallaxMap3DProp { get; } = new(PropertyNames.ParallaxMap3D);
        public ParticlesGUI.Property ParallaxMapProgressProp { get; } =
            new(PropertyNames.ParallaxMapProgress);

        public ParticlesGUI.Property ParallaxMapProgressCoordProp { get; } =
            new(PropertyNames.ParallaxMapProgressCoord);

        public ParticlesGUI.Property ParallaxMapOffsetXCoordProp { get; } =
            new(PropertyNames.ParallaxMapOffsetXCoord);
        public ParticlesGUI.Property ParallaxMapOffsetYCoordProp { get; } =
            new(PropertyNames.ParallaxMapOffsetYCoord);
        public ParticlesGUI.Property ParallaxMapSliceCountProp { get; } =
            new(PropertyNames.ParallaxMapSliceCount);
        public ParticlesGUI.Property ParallaxMapChannel { get; } =
            new(PropertyNames.ParallaxMapChannel);
        public ParticlesGUI.Property ParallaxStrengthProp { get; } =
            new(PropertyNames.ParallaxStrength);
        public ParticlesGUI.Property ParallaxMapTargetProp { get; } =
            new(PropertyNames.ParallaxMapTarget);

        // Parallax Map Random Row Selection
        public ParticlesGUI.Property ParallaxMapRandomRowSelectionEnabledProp { get; } =
            new(PropertyNames.ParallaxMapRandomRowSelectionEnabled);
        public ParticlesGUI.Property ParallaxMapRandomRowCoordProp { get; } =
            new(PropertyNames.ParallaxMapRandomRowCoord);
        public ParticlesGUI.Property ParallaxMapRowCountProp { get; } =
            new(PropertyNames.ParallaxMapRowCount);
        ...
        public ParticlesGUI.Property ColorCorrectionModeProp { get; } =
            new(PropertyNames.ColorCorrectionMode);
        ...
        public ParticlesGUI.Property AlphaTransitionMap3DProp { get; } =
            new(PropertyNames.AlphaTransitionMap3D);
        ...
        public ParticlesGUI.Property DissolveSharpnessProp { get; } =
            new(PropertyNames.DissolveSharpness);
        ...
        public ParticlesGUI.Property AlphaTransitionProgressProp { get; } =
            new(PropertyNames.AlphaTransitionProgress);
        ...
        // Alpha Transition Random Row Selection
        public ParticlesGUI.Property AlphaTransitionMapRandomRowSelectionEnabledProp { get; } =
            new(PropertyNames.AlphaTransitionMapRandomRowSelectionEnabled);
        public ParticlesGUI.Property AlphaTransitionMapRandomRowCoordProp { get; } =
            new(PropertyNames.AlphaTransitionMapRandomRowCoord);
        public ParticlesGUI.Property AlphaTransitionMapRowCountProp { get; } =
            new(PropertyNames.AlphaTransitionMapRowCount);

        // Alpha Transition Second Texture Random Row Selection
        public ParticlesGUI.Property AlphaTransitionMapSecondTextureRandomRowSelectionEnabledProp { get; } =
            new(PropertyNames.AlphaTransitionMapSecondTextureRandomRowSelectionEnabled);
        public ParticlesGUI.Property AlphaTransitionMapSecondTextureRandomRowCoordProp { get; } =
            new(PropertyNames.AlphaTransitionMapSecondTextureRandomRowCoord);
        public ParticlesGUI.Property AlphaTransitionMapSecondTextureRowCountProp { get; } =
            new(PropertyNames.AlphaTransitionMapSecondTextureRowCount);

        // Alpha Transition Map Rotation
        public ParticlesGUI.Property AlphaTransitionMapRotationProp { get; } =
            new(PropertyNames.AlphaTransitionMapRotation);
        public ParticlesGUI.Property AlphaTransitionMapRotationCoordProp { get; } =
            new(PropertyNames.AlphaTransitionMapRotationCoord);
        public ParticlesGUI.Property AlphaTransitionMapRotationOffsetsProp { get; } =
            new(PropertyNames.AlphaTransitionMapRotationOffsets);

        // Alpha Transition Map Second Texture Rotation
        public ParticlesGUI.Property AlphaTransitionMapSecondTextureRotationProp { get; } =
            new(PropertyNames.AlphaTransitionMapSecondTextureRotation);
        public ParticlesGUI.Property AlphaTransitionMapSecondTextureRotationCoordProp { get; } =
            new(PropertyNames.AlphaTransitionMapSecondTextureRotationCoord);
        public ParticlesGUI.Property AlphaTransitionMapSecondTextureRotationOffsetsProp { get; } =
            new(PropertyNames.AlphaTransitionMapSecondTextureRotationOffsets);
        ...
        public ParticlesGUI.Property EmissionAreaTypeProp { get; } =
            new(PropertyNames.EmissionAreaType);

        public ParticlesGUI.Property EmissionMapModeProp { get; } =
            new(PropertyNames.EmissionMapMode);
        ...
        public ParticlesGUI.Property EmissionMap2DArrayProp { get; } =
            new(PropertyNames.EmissionMap2DArray);
        ...
        public ParticlesGUI.Property EmissionMapProgressProp { get; } =
            new(PropertyNames.EmissionMapProgress);
        ...
        public ParticlesGUI.Property EmissionMapOffsetXCoordProp { get; } =
            new(PropertyNames.EmissionMapOffsetXCoord);

        public ParticlesGUI.Property EmissionMapOffsetYCoordProp { get; } =
            new(PropertyNames.EmissionMapOffsetYCoord);

        // Emission Map Rotation
        public ParticlesGUI.Property EmissionMapRotationProp { get; } =
            new(PropertyNames.EmissionMapRotation);
        public ParticlesGUI.Property EmissionMapRotationCoordProp { get; } =
            new(PropertyNames.EmissionMapRotationCoord);
        public ParticlesGUI.Property EmissionMapRotationOffsetsProp { get; } =
            new(PropertyNames.EmissionMapRotationOffsets);

        public ParticlesGUI.Property EmissionMapChannelsXProp { get; } =
            new(PropertyNames.EmissionMapChannelsX);

        public ParticlesGUI.Property EmissionMapSliceCountProp { get; } =
            new(PropertyNames.EmissionMapSliceCount);

        public ParticlesGUI.Property EmissionColorTypeProp { get; } =
            new(PropertyNames.EmissionColorType);
        ...
        public ParticlesGUI.Property EmissionColorRampProp { get; } =
            new(PropertyNames.EmissionColorRamp);

        public ParticlesGUI.Property EmissionIntensityProp { get; } =
            new(PropertyNames.EmissionIntensity);

        public ParticlesGUI.Property EmissionIntensityCoordProp { get; } =
            new(PropertyNames.EmissionIntensityCoord);

        public ParticlesGUI.Property KeepEdgeTransparencyProp { get; } =
            new(PropertyNames.KeepEdgeTransparency);

        // Emission Random Row Selection
        public ParticlesGUI.Property EmissionMapRandomRowSelectionEnabledProp { get; } =
            new(PropertyNames.EmissionMapRandomRowSelectionEnabled);
        public ParticlesGUI.Property EmissionMapRandomRowCoordProp { get; } =
            new(PropertyNames.EmissionMapRandomRowCoord);
        public ParticlesGUI.Property EmissionMapRowCountProp { get; } =
            new(PropertyNames.EmissionMapRowCount);
        ...
        public ParticlesGUI.Property RimTransparencyEnabledProp { get; } =
            new(PropertyNames.RimTransparencyEnabled);

        public ParticlesGUI.Property RimTransparencyProgressProp { get; } =
            new(PropertyNames.RimTransparencyProgress);
        ...
        public ParticlesGUI.Property InverseRimTransparencyProp { get; } =
            new(PropertyNames.InverseRimTransparency);
        ...
        public ParticlesGUI.Property SoftParticlesEnabledProp { get; } =
            new(PropertyNames.SoftParticlesEnabled);

        public ParticlesGUI.Property SoftParticlesIntensityProp { get; } =
            new(PropertyNames.SoftParticlesIntensity);

        public ParticlesGUI.Property DepthFadeEnabledProp { get; } =
            new(PropertyNames.DepthFadeEnabled);

        public ParticlesGUI.Property DepthFadeNearProp { get; } = new(PropertyNames.DepthFadeNear);

        public ParticlesGUI.Property DepthFadeFarProp { get; } = new(PropertyNames.DepthFadeFar);

        public ParticlesGUI.Property DepthFadeWidthProp { get; } =
            new(PropertyNames.DepthFadeWidth);

        #endregion

        #region VertexDeformation Map Material Properties

        public ParticlesGUI.Property VertexDeformationMapProp { get; } =
            new(PropertyNames.VertexDeformationMap);
        ...
        public ParticlesGUI.Property ShadowCasterEnabledProp { get; } =
            new(PropertyNames.ShadowCasterEnabled);
        ...
        public ParticlesGUI.Property ShadowCasterAlphaCutoffProp { get; } =
            new(PropertyNames.ShadowCasterAlphaCutoff);
