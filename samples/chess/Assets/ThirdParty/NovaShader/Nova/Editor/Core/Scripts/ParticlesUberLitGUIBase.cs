...
namespace Nova.Editor.Core.Scripts
{
    ...
    /// </summary>
    internal class ParticlesUberLitGUIBase<TCustomCoord> : ParticlesGUI
        where TCustomCoord : Enum
    {
        ...
        protected override void DrawGUI(MaterialEditor editor, MaterialProperty[] properties)
        {
            ...
            // Surface
            _commonGUI.DrawProperties(
                SurfaceMapsFoldout,
                "Surface Maps",
                InternalDrawSurfaceMapsProperties
            ); // Tint Color
            // Tint Color
        ...
        private void InternalDrawSurfaceMapsTexturePropertiesCore(
            string label,
            Property map2DProp,
            Property map2DArrayProp,
            Property map3DProp,
            Property normalizedValueProp,
        ...
        private void InternalRenderSettingsProperties()
        {
            ...
            MaterialEditorUtility.DrawEnumProperty<LitWorkflowMode>(
                _editor,
                "Work Flow Mode",
            ...
            MaterialEditorUtility.DrawToggleProperty(
                _editor,
                "Receive Shadows",
                _litReceiveShadowsProp.Value
            );
            MaterialEditorUtility.DrawToggleProperty(
                _editor,
                "Specular Highlights",
                _specularHighlightsProp.Value
            );
            MaterialEditorUtility.DrawToggleProperty(
                _editor,
        ...
        // Environment Reflections
        private readonly Property _environmentReflectionsProp = new(
            PropertyNames.EnvironmentReflections
        );
        ...
        private readonly Property _metallicMapChannelsXProp = new(
            PropertyNames.MetallicMapChannelsX
        );

        // smoothnessMap
        private readonly Property _smoothnessMapProp = new(PropertyNames.SmoothnessMap);
        private readonly Property _smoothnessMap2DArrayProp = new(
            PropertyNames.SmoothnessMap2DArray
        );
        ...
        private readonly Property _smoothnessMapChannelsXProp = new(
            PropertyNames.SmoothnessMapChannelsX
        );
