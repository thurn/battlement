...
namespace Nova.Editor.Core.Scripts
{
    ...
    /// </summary>
    internal class ParticlesUberCommonGUI<TCustomCoord>
        where TCustomCoord : Enum
    {
        public ParticlesUberCommonGUI(MaterialEditor editor)
        {
            var material = editor.target as Material;
            _renderersUsingThisMaterial = RendererErrorHandler.FindAllRenderersWithMaterial(
                material
            );
        }
        ...
        )
        {
            ...
            RendererErrorHandler.SetupCorrectVertexStreams(
                _editor.target as Material,
                out _correctVertexStreams,
        ...
        {
            DrawProperties(
                _commonMaterialProperties.RenderSettingsFoldout,
                "Render Settings",
        ...
        {
            DrawProperties(
                _commonMaterialProperties.BaseMapFoldout,
                "Base Map",
                InternalDrawBaseMapProperties
            );
        }
        ...
        {
            DrawProperties(
                _commonMaterialProperties.ParallaxMapFoldout,
                "Parallax Map",
                InternalDrawParallaxMapsProperties
            );
        }
        ...
        {
            DrawProperties(
                _commonMaterialProperties.TintColorFoldout,
                "Tint Color",
                InternalDrawTintColorProperties
            );
        }
        ...
        {
            DrawProperties(
                _commonMaterialProperties.FlowMapFoldout,
                "Flow Map",
                InternalDrawFlowMapProperties
            );
        }
        ...
        {
            DrawProperties(
                _commonMaterialProperties.ColorCorrectionFoldout,
                "Color Correction",
                InternalDrawColorCorrectionProperties
            );
        }
        ...
        {
            DrawProperties(
                _commonMaterialProperties.AlphaTransitionFoldout,
                "Alpha Transition",
                InternalDrawAlphaTransitionProperties
            );
        }
        ...
        {
            DrawProperties(
                _commonMaterialProperties.EmissionFoldout,
                "Emission",
                InternalDrawEmissionProperties
            );
        }
        ...
        {
            DrawProperties(
                _commonMaterialProperties.TransparencyFoldout,
                "Transparency",
                InternalDrawTransparencyProperties
            );
        }
        ...
        {
            DrawProperties(
                _commonMaterialProperties.VertexDeformationFoldout,
                "Vertex Deformation",
        ...
        {
            DrawProperties(
                _commonMaterialProperties.ShadowCasterFoldout,
                "Shadow Caster",
                InternalDrawShadowCasterProperties
            );
        }
        ...
        {
            if (
                !RendererErrorHandler.CheckError(
                    _renderersUsingThisMaterial,
                    _editor.target as Material,
        ...
        public void DrawProperties(
            BoolEditorPrefsProperty foldout,
            string categoryName,
            Action internalDrawFunction
        )
        {
            using var foldoutScope = new MaterialEditorUtility.FoldoutHeaderScope(
                foldout.Value,
                categoryName
            );
            if (foldoutScope.Foldout)
                internalDrawFunction();
        ...
        public void DrawRenderSettingsPropertiesCore()
        {
            ...
            MaterialEditorUtility.DrawEnumProperty<RenderType>(
                _editor,
                "Render Type",
                props.RenderTypeProp.Value
            );
            ...
            if (renderType == RenderType.Cutout)
                ...
                MaterialEditorUtility.DrawEnumProperty<TransparentBlendMode>(
                    _editor,
                    "Blend Mode",
                    props.TransparentBlendModeProp.Value
                );

            MaterialEditorUtility.DrawEnumProperty<RenderFace>(
                _editor,
                "Render Face",
                props.CullProp.Value
            );
            MaterialEditorUtility.DrawIntRangeProperty(
                _editor,
                "Render Priority",
                props.QueueOffsetProp.Value,
                RenderPriorityMin,
                RenderPriorityMax
            );
            MaterialEditorUtility.DrawEnumProperty<VertexAlphaMode>(
                _editor,
                "Vertex Alpha Mode",
                props.VertexAlphaModeProp.Value
            );
            MaterialEditorUtility.DrawEnumProperty<ZWriteOverride>(
                _editor,
                "ZWrite",
        ...
        {
            var props = _commonMaterialProperties;
            MaterialEditorUtility.DrawEnumProperty<BaseMapMode>(
                _editor,
                "Mode",
                props.BaseMapModeProp.Value
            );
            ...
            using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
            {
                ...
                {
                    if (
                        baseMapMode == BaseMapMode.FlipBook
                        && props.BaseMap2DArrayProp.Value.textureValue != null
                    )
                    {
                        var tex2DArray = (Texture2DArray)
                            props.BaseMap2DArrayProp.Value.textureValue;
            ...
            MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                _editor,
                "Rotation",
                props.BaseMapRotationProp.Value,
                props.BaseMapRotationCoordProp.Value
            );
            using (new EditorGUI.IndentLevelScope())
            {
                MaterialEditorUtility.DrawVector2Property(
                    _editor,
                    "Offset",
                    props.BaseMapRotationOffsetsProp.Value
                );
            }

            MaterialEditorUtility.DrawToggleProperty(
                _editor,
                "Mirror Sampling",
            ...
            if (baseMapMode == BaseMapMode.FlipBook || baseMapMode == BaseMapMode.FlipBookBlending)
            {
                MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                    _editor,
                    "Flip-Book Progress",
                    props.BaseMapProgressProp.Value,
                    props.BaseMapProgressCoordProp.Value
                );
            ...
            if (baseMapMaterialProp != null)
            {
                ...
                if (toneMode != BaseMapToneMode.None)
                {
                    using (new EditorGUI.IndentLevelScope())
                    {
                        ...
                        MaterialEditorUtility.DrawEnumProperty<ColorChannels>(
                            _editor,
                            "Tone Channel",
                        ...
                        using (var changeScope = new EditorGUI.ChangeCheckScope())
                        {
                            ...
                            _editor.ShaderProperty(
                                props.ToneHighlightsColorProp.Value,
                                "Highlights Color"
                            );
                            ...
                            {
                                _editor.ShaderProperty(
                                    props.ToneBrightsColorProp.Value,
                                    "Brights Color"
                                );
                            }

                            _editor.ShaderProperty(
                                props.ToneMidtonesColorProp.Value,
                                "Midtones Color"
                            );
                            ...
                            {
                                _editor.ShaderProperty(
                                    props.ToneDarktonesColorProp.Value,
                                    "Darktones Color"
                                );
                            }

                            _editor.ShaderProperty(
                                props.ToneShadowsColorProp.Value,
                                "Shadows Color"
                            );
                        }
                        ...
                        if (toneMode == BaseMapToneMode.Pentone)
                        {
                            using (var brightsChangeScope = new EditorGUI.ChangeCheckScope())
                            {
                                ...
                                if (brightsChangeScope.changed)
                                {
                                    ...
                                    props.ToneBrightsProp.Value.floatValue = Mathf.Clamp(
                                        brightsValue,
                                        0.001f,
                                        0.999f
                                    );
                        ...
                        using (var midtonesChangeScope = new EditorGUI.ChangeCheckScope())
                        {
                            ...
                            if (midtonesChangeScope.changed)
                            {
                                ...
                                props.ToneMidtonesProp.Value.floatValue = Mathf.Clamp(
                                    midtonesValue,
                                    0.001f,
                                    0.999f
                                );
                        ...
                        if (toneMode == BaseMapToneMode.Pentone)
                        {
                            using (var darktonesChangeScope = new EditorGUI.ChangeCheckScope())
                            {
                                ...
                                if (darktonesChangeScope.changed)
                                {
                                    ...
                                    props.ToneDarktonesProp.Value.floatValue = Mathf.Clamp(
                                        darktonesValue,
                                        0.001f,
                                        0.999f
                                    );
        ...
        {
            var props = _commonMaterialProperties;
            MaterialEditorUtility.DrawEnumProperty<ParallaxMapMode>(
                _editor,
                "TextureMode",
            ...
            using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
            {
                ...
                if (changeCheckScope.changed)
                {
                    ...
                    {
                        var tex2DArray = (Texture2DArray)
                            props.ParallaxMap2DArrayProp.Value.textureValue;
        ...
        {
            var props = _commonMaterialProperties;
            MaterialEditorUtility.DrawEnumProperty<TintAreaMode>(
                _editor,
                "Mode",
                props.TintAreaModeProp.Value
            );
            ...
            if (tintAreaMode == TintAreaMode.Rim)
                using (new EditorGUI.IndentLevelScope())
                {
                    MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                        _editor,
                        "Progress",
                        props.TintRimProgressProp.Value,
                    ...
                    MaterialEditorUtility.DrawToggleProperty(
                        _editor,
                        "Inverse",
                        props.InverseTintRimProp.Value
                    );
                }

            MaterialEditorUtility.DrawEnumProperty<TintColorMode>(
                _editor,
                "Color Mode",
                props.TintColorModeProp.Value
            );
            ...
            else if (tintColorMode == TintColorMode.SingleTexture)
            {
                MaterialEditorUtility.DrawTexture<TCustomCoord>(
                    _editor,
                    props.TintMapProp.Value,
                    props.TintMapOffsetXCoordProp.Value,
                    props.TintMapOffsetYCoordProp.Value,
                    null,
                    null
                );
            }
            else if (tintColorMode == TintColorMode.FlipBookBlending)
            {
                ...
                MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                    _editor,
                    "Flip-Book Progress",
                    props.TintMap3DProgressProp.Value,
                    props.TintMap3DProgressCoordProp.Value
                );
            }
            else if (tintColorMode == TintColorMode.FlipBook)
            {
                using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
                {
                    MaterialEditorUtility.DrawTexture<TCustomCoord>(
                        _editor,
                        props.TintMap2DArrayProp.Value,
                        props.TintMapOffsetXCoordProp.Value,
                        props.TintMapOffsetYCoordProp.Value,
                        null,
                        null
                    ...
                    if (
                        changeCheckScope.changed
                        && props.TintMap2DArrayProp.Value.textureValue != null
                    )
                    {
                        var tex2DArray = (Texture2DArray)
                            props.TintMap2DArrayProp.Value.textureValue;
                ...
                MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                    _editor,
                    "Flip-Book Progress",
                    props.TintMapProgressProp.Value,
                    props.TintMapProgressCoordProp.Value
                );
            }
            ...
            if (tintColorMode != TintColorMode.SingleColor)
            {
                MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                    _editor,
                    "Rotation",
                    props.TintMapRotationProp.Value,
                    props.TintMapRotationCoordProp.Value
                );
                using (new EditorGUI.IndentLevelScope())
                {
                    MaterialEditorUtility.DrawVector2Property(
                        _editor,
                        "Offset",
                        props.TintMapRotationOffsetsProp.Value
                    );
                }
            }
        }
        ...
        private void InternalDrawFlowMapProperties()
        {
            ...
            MaterialEditorUtility.DrawTexture<TCustomCoord>(
                _editor,
                props.FlowMapProp.Value,
                props.FlowMapOffsetXCoordProp.Value,
                props.FlowMapOffsetYCoordProp.Value,
                props.FlowMapChannelsXProp.Value,
                props.FlowMapChannelsYProp.Value
            );
            MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                _editor,
                "Intensity",
            ...
            MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                _editor,
                "Rotation",
                props.FlowMapRotationProp.Value,
                props.FlowMapRotationCoordProp.Value
            );
            using (new EditorGUI.IndentLevelScope())
            {
                MaterialEditorUtility.DrawVector2Property(
                    _editor,
                    "Offset",
                    props.FlowMapRotationOffsetsProp.Value
                );
            }
        ...
        {
            var props = _commonMaterialProperties;
            MaterialEditorUtility.DrawEnumProperty<ColorCorrectionMode>(
                _editor,
                "Mode",
                props.ColorCorrectionModeProp.Value
            );
            var colorCorrectionMode = (ColorCorrectionMode)
                props.ColorCorrectionModeProp.Value.floatValue;
            if (colorCorrectionMode == ColorCorrectionMode.GradientMap)
                MaterialEditorUtility.DrawTexture<TCustomCoord>(
                    _editor,
                    props.GradientMapProp.Value,
                    false
                );
        }
        ...
        {
            var props = _commonMaterialProperties;
            MaterialEditorUtility.DrawEnumProperty<AlphaTransitionMode>(
                _editor,
                "Mode",
            ...
            {
                MaterialEditorUtility.DrawEnumProperty<AlphaTransitionMapMode>(
                    _editor,
                    "Map Mode",
                    props.AlphaTransitionMapModeProp.Value
                );
                var alphaTransitionMapMode = (AlphaTransitionMapMode)
                    props.AlphaTransitionMapModeProp.Value.floatValue;
                ...
                using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
                {
                    MaterialEditorUtility.DrawTexture<TCustomCoord>(
                        _editor,
                        alphaTransitionMapProp,
                        props.AlphaTransitionMapOffsetXCoordProp.Value,
                        props.AlphaTransitionMapOffsetYCoordProp.Value,
                        props.AlphaTransitionMapChannelsXProp.Value,
                        null
                    );
                    ...
                    if (changeCheckScope.changed)
                    {
                        ...
                        {
                            var tex2DArray = (Texture2DArray)
                                props.AlphaTransitionMap2DArrayProp.Value.textureValue;
                            props.AlphaTransitionMapSliceCountProp.Value.floatValue =
                                tex2DArray.depth;
                        }
                        ...
                        {
                            var tex3D = (Texture3D)
                                props.AlphaTransitionMap3DProp.Value.textureValue;
                ...
                )
                {
                    MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                        _editor,
                        "Flip-Book Progress",
                        props.AlphaTransitionMapProgressProp.Value,
                        props.AlphaTransitionMapProgressCoordProp.Value
                    );
                ...
                MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                    _editor,
                    "Rotation",
                    props.AlphaTransitionMapRotationProp.Value,
                    props.AlphaTransitionMapRotationCoordProp.Value
                );
                using (new EditorGUI.IndentLevelScope())
                {
                    MaterialEditorUtility.DrawVector2Property(
                        _editor,
                        "Offset",
                        props.AlphaTransitionMapRotationOffsetsProp.Value
                    );
                }
                ...
                MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                    _editor,
                    "Transition Progress",
                    props.AlphaTransitionProgressProp.Value,
                    props.AlphaTransitionProgressCoordProp.Value
                );
                ...
                // 2nd Texture
                {
                    MaterialEditorUtility.DrawEnumProperty<AlphaTransitionBlendMode>(
                        _editor,
                        "2nd Texture Blend Mode",
                        props.AlphaTransitionSecondTextureBlendModeProp.Value
                    );
                    var alphaTransitionSecondTextureBlendMode = (AlphaTransitionBlendMode)
                        props.AlphaTransitionSecondTextureBlendModeProp.Value.floatValue;
                    if (alphaTransitionSecondTextureBlendMode != AlphaTransitionBlendMode.None)
                    {
                        ...
                        var alphaTransitionSecondTextureMapMode = (AlphaTransitionMapMode)
                            props.AlphaTransitionMapSecondTextureMapModeProp.Value.floatValue;

                        MaterialProperty alphaTransitionMapSecondTexturePropLocal;
                        switch (alphaTransitionSecondTextureMapMode)
                        {
                            case AlphaTransitionMapMode.SingleTexture:
                                alphaTransitionMapSecondTexturePropLocal = props
                                    .AlphaTransitionMapSecondTextureProp
                                    .Value;
                                break;
                            case AlphaTransitionMapMode.FlipBook:
                                alphaTransitionMapSecondTexturePropLocal = props
                                    .AlphaTransitionMapSecondTexture2DArrayProp
                                    .Value;
                                break;
                            case AlphaTransitionMapMode.FlipBookBlending:
                                alphaTransitionMapSecondTexturePropLocal = props
                                    .AlphaTransitionMapSecondTexture3DProp
                                    .Value;
                                break;
                            default:
                                throw new ArgumentOutOfRangeException();
                        ...
                        using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
                        {
                            MaterialEditorUtility.DrawTexture<TCustomCoord>(
                                ...
                                props.AlphaTransitionMapSecondTextureChannelsXProp.Value,
                                null
                            );
                            ...
                            {
                                if (
                                    alphaTransitionSecondTextureMapMode
                                        == AlphaTransitionMapMode.FlipBook
                                    && props
                                        .AlphaTransitionMapSecondTexture2DArrayProp
                                        .Value
                                        .textureValue != null
                                )
                                {
                                    var tex2DArray = (Texture2DArray)
                                        props
                                            ...
                                            .textureValue;
                                    props
                                        .AlphaTransitionMapSecondTextureSliceCountProp
                                        .Value
                                        .floatValue = tex2DArray.depth;
                                }

                                if (
                                    alphaTransitionSecondTextureMapMode
                                        == AlphaTransitionMapMode.FlipBookBlending
                                    && props
                                        .AlphaTransitionMapSecondTexture3DProp
                                        .Value
                                        .textureValue != null
                                )
                                {
                                    ...
                                    props
                                        .AlphaTransitionMapSecondTextureSliceCountProp
                                        .Value
                                        .floatValue = tex3D.depth;
                                }
                            }
                        }

                        if (
                            alphaTransitionSecondTextureMapMode == AlphaTransitionMapMode.FlipBook
                            || alphaTransitionSecondTextureMapMode
                                == AlphaTransitionMapMode.FlipBookBlending
                        )
                        {
                            ...
                            MaterialEditorUtility.DrawRandomRowSelection<TCustomCoord>(
                                _editor,
                                props
                                    .AlphaTransitionMapSecondTextureRandomRowSelectionEnabledProp
                                    .Value,
                        ...
                        MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                            _editor,
                            "Rotation",
                            props.AlphaTransitionMapSecondTextureRotationProp.Value,
                            props.AlphaTransitionMapSecondTextureRotationCoordProp.Value
                        );
                        using (new EditorGUI.IndentLevelScope())
                        {
                            MaterialEditorUtility.DrawVector2Property(
                                _editor,
                                "Offset",
                                props.AlphaTransitionMapSecondTextureRotationOffsetsProp.Value
                            );
                        }
                        ...
                        if (mode == AlphaTransitionMode.Dissolve)
                            _editor.ShaderProperty(
                                props.DissolveSharpnessSecondTextureProp.Value,
                                "Edge Sharpness"
                            );
                    }
                }
        ...
        {
            var props = _commonMaterialProperties;
            MaterialEditorUtility.DrawEnumProperty<EmissionAreaType>(
                _editor,
                "Mode",
            ...
            if (areaType != EmissionAreaType.None)
            {
                ...
                {
                    MaterialEditorUtility.DrawEnumProperty<EmissionColorTypeForAllArea>(
                        _editor,
                        "Color Type",
                ...
                {
                    MaterialEditorUtility.DrawEnumProperty<EmissionMapMode>(
                        _editor,
                        "Map Mode",
                        props.EmissionMapModeProp.Value
                    );
                    var emissionMapMode = (EmissionMapMode)
                        props.EmissionMapModeProp.Value.floatValue;
                    ...
                    using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
                    {
                        MaterialEditorUtility.DrawTexture<TCustomCoord>(
                            ...
                            props.EmissionMapOffsetYCoordProp.Value,
                            props.EmissionMapChannelsXProp.Value,
                            null
                        );
                        ...
                        if (changeCheckScope.changed)
                        {
                            ...
                            {
                                var tex2DArray = (Texture2DArray)
                                    props.EmissionMap2DArrayProp.Value.textureValue;
                    ...
                    )
                    {
                        MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                            _editor,
                            "Flip-Book Progress",
                            props.EmissionMapProgressProp.Value,
                            props.EmissionMapProgressCoordProp.Value
                        );
                    ...
                    MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                        _editor,
                        "Rotation",
                        props.EmissionMapRotationProp.Value,
                        props.EmissionMapRotationCoordProp.Value
                    );
                    using (new EditorGUI.IndentLevelScope())
                    {
                        MaterialEditorUtility.DrawVector2Property(
                            _editor,
                            "Offset",
                            props.EmissionMapRotationOffsetsProp.Value
                        );
                    }

                    MaterialEditorUtility.DrawEnumProperty<EmissionColorType>(
                        _editor,
                        "Color Type",
                        props.EmissionColorTypeProp.Value
                    );
                ...
                if (colorType == EmissionColorType.Color)
                    ...
                    MaterialEditorUtility.DrawTexture<TCustomCoord>(
                        _editor,
                        props.EmissionColorRampProp.Value,
                        false
                    );
                ...
                using (var ccs2 = new EditorGUI.ChangeCheckScope())
                {
                    MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                        _editor,
                        "Intensity",
                        props.EmissionIntensityProp.Value,
                        props.EmissionIntensityCoordProp.Value
                    );
                    if (ccs2.changed)
                        props.EmissionIntensityProp.Value.floatValue = Mathf.Max(
                            0,
        ...
        private void InternalDrawTransparencyProperties()
        {
            ...
            MaterialEditorUtility.DrawToggleProperty(
                _editor,
                "Rim",
                props.RimTransparencyEnabledProp.Value
            );
            if (props.RimTransparencyEnabledProp.Value.floatValue > 0.5f)
                using (new EditorGUI.IndentLevelScope())
                {
                    MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                        _editor,
                        "Progress",
                        props.RimTransparencyProgressProp.Value,
                        props.RimTransparencyProgressCoordProp.Value
                    );
                    MaterialEditorUtility.DrawPropertyAndCustomCoord<TCustomCoord>(
                        _editor,
                        "Sharpness",
                        props.RimTransparencySharpnessProp.Value,
                        props.RimTransparencySharpnessCoordProp.Value
                    );
                    MaterialEditorUtility.DrawToggleProperty(
                        _editor,
                        "Inverse",
            ...
            MaterialEditorUtility.DrawToggleProperty(
                _editor,
                "Soft Particles",
                props.SoftParticlesEnabledProp.Value
            );
            ...
            if (softParticlesEnabled)
                ...
                using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
                {
                    ...
                    if (changeCheckScope.changed)
                        props.SoftParticlesIntensityProp.Value.floatValue = Mathf.Max(
                            0,
            ...
            MaterialEditorUtility.DrawToggleProperty(
                _editor,
                "Depth Fade",
                props.DepthFadeEnabledProp.Value
            );
            ...
            if (depthFadeEnabled)
                ...
                using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
                {
                    MaterialEditorUtility.DrawTwoFloatProperties(
                        "Distance",
                        props.DepthFadeNearProp.Value,
                        "Near",
                        props.DepthFadeFarProp.Value,
                        "Far",
                        _editor
                    );
        ...
        private void InternalDrawVertexDeformationMapProperties()
        {
            ...
            MaterialEditorUtility.DrawFloatRangeProperty(
                _editor,
                "Base Value",
                props.VertexDeformationBaseValueProp.Value,
                0,
                1
            );
        }
        ...
        private void InternalDrawShadowCasterProperties()
        {
            ...
            MaterialEditorUtility.DrawToggleProperty(
                _editor,
                "Enable",
                props.ShadowCasterEnabledProp.Value
            );
            ...
            MaterialEditorUtility.DrawFloatRangeProperty(
                _editor,
                "Cutoff",
                props.ShadowCasterAlphaCutoffProp.Value,
                0,
                1
            );
            EditorGUI.indentLevel--;
        ...
        private static readonly GUIContent StreamApplyToAllSystemsText = new(
            "Fix Now",
        ...
        private void DrawTriTonePreview(
            Color shadow,
            Color midtones,
            Color highlight,
            float shadowBoundary,
            float midtonesBalance,
            float highlightBoundary
        )
        {
            const float MIN_RANGE = 0.01f;
        ...
        private void DrawGrayscaleReference(
            float shadowBoundary,
            float midpoint,
            float highlightBoundary
        )
        ...
        private void DrawTriToneGradient(
            Color shadow,
            Color midtones,
            Color highlight,
            float shadowBoundary,
        ...
        private void DrawPentonePreview(
            Color shadow,
            Color darktones,
            Color midtones,
            Color brights,
            ...
            float midtonesBalance,
            float highlightBoundary,
            float brightsBalance,
            float darktonesBalance
        )
        {
            const float MIN_RANGE = 0.01f;
            highlightBoundary = Mathf.Max(shadowBoundary + MIN_RANGE, highlightBoundary);
        ...
        private void DrawPentoneGradient(
            Color shadow,
            Color darktones,
            Color midtones,
            Color brights,
            Color highlight,
            float shadowBoundary,
            float darktonesBoundary,
            float midpoint,
            float brightsBoundary,
            float highlightBoundary
        )
        {
            Rect rect = EditorGUILayout.GetControlRect(false, 24);
            ...
            for (int i = 0; i < steps; i++)
            {
                ...
                color = Color.Lerp(
                    color,
                    darktones,
                    Mathf.InverseLerp(shadowBoundary, darktonesBoundary, t)
                );
                color = Color.Lerp(
                    color,
                    midtones,
                    Mathf.InverseLerp(darktonesBoundary, midpoint, t)
                );
                color = Color.Lerp(color, brights, Mathf.InverseLerp(midpoint, brightsBoundary, t));
                color = Color.Lerp(
                    color,
                    highlight,
                    Mathf.InverseLerp(brightsBoundary, highlightBoundary, t)
                );
                color.a = 1.0f; // Ensure alpha is always 1.0
