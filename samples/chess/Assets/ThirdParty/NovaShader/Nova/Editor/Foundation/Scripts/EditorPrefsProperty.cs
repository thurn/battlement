...
namespace Nova.Editor.Foundation.Scripts
{
    ...
    {
        public IntEditorPrefsProperty(string key, int defaultValue)
            : base(key, defaultValue, EditorPrefs.GetInt, EditorPrefs.SetInt) { }
    }

    internal sealed class FloatEditorPrefsProperty : EditorPrefsProperty<float>
    {
        public FloatEditorPrefsProperty(string key, float defaultValue)
            : base(key, defaultValue, EditorPrefs.GetFloat, EditorPrefs.SetFloat) { }
    }

    internal sealed class BoolEditorPrefsProperty : EditorPrefsProperty<bool>
    {
        public BoolEditorPrefsProperty(string key, bool defaultValue)
            : base(key, defaultValue, EditorPrefs.GetBool, EditorPrefs.SetBool) { }
    }

    internal sealed class StringEditorPrefsProperty : EditorPrefsProperty<string>
    {
        public StringEditorPrefsProperty(string key, string defaultValue)
            : base(key, defaultValue, EditorPrefs.GetString, EditorPrefs.SetString) { }
    }
}
