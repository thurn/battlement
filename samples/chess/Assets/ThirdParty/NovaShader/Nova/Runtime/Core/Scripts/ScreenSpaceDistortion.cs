...
namespace Nova.Runtime.Core.Scripts
{
    ...
    public sealed class ScreenSpaceDistortion : ScriptableRendererFeature
    {
        ...
        public override void Create()
        {
            ...
            _distortedUvBufferFormat = SystemInfo.SupportsRenderTextureFormat(
            ...
            _applyDistortionPass = new ApplyDistortionPass(
                _applyToSceneView,
                _applyDistortionShader
            );
        }
        ...
        {
            return (
                    UniversalRenderPipelineDebugDisplaySettings.Instance?.IsPostProcessingAllowed
                    ?? true
