...
pub(crate) fn radio_group() -> Style {
    Style::new()
        .color(PRIMARY_TEXT)
        .font_size(19)
        .padding(12)
        .background_color(Color::rgb(0.055, 0.145, 0.17))
        .border_color(Color::rgb(0.16, 0.4, 0.45))
        .border_width(1)
        .border_radius(9)
}

pub(crate) fn toggle_group() -> Style {
    Style::new()
...
pub(crate) fn field_label() -> Style {
    Style::new()
        .color(PRIMARY_TEXT)
        .font_size(16)
        .margin((0, 0, 2, 12))
...
pub(crate) fn toggle_button(selected: bool) -> Style {
    let style = Style::new()
        .width(31_f32.pct())
        .height(52)
        .margin((8, 6, 0, 0))
        ...
        .border_radius(7);
    if selected {
        style.background_color(ACCENT).color(BACKGROUND)
    } else {
        style
            .background_color(Color::rgb(0.045, 0.12, 0.14))
            .color(PRIMARY_TEXT)
    }
}

pub(crate) fn selection_summary() -> Style {
    Style::new().color(CYAN).font_size(16).margin((10, 0, 0, 0))
}
