...
pub(crate) fn source_card(source: BackgroundSource, variant: usize) -> Style {
  base_card()
    ...
    .background_repeat(match variant {
      0 => BackgroundRepeat::new(BackgroundRepeatMode::Repeat, BackgroundRepeatMode::NoRepeat),
      ...
      _ => BackgroundRepeat::new(BackgroundRepeatMode::NoRepeat, BackgroundRepeatMode::Repeat),
    })
