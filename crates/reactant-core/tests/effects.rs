...
impl Component for ReadyEffect {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls(if ready { "ready" } else { "waiting" }))
  }
}
...
impl Component for FrequencyEffects {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("frequency"))
  }
}
...
impl Component for OrderedParent {
  fn render(&self) -> impl Render {
    ...
    (
      ...
      reactant_core::host::Label::new(ls("parent")),
    )
  }
}
...
impl Component for OrderedChild {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("child"))
  }
}
...
impl Component for PanicEffect {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("committed"))
  }
}
...
impl Component for RetriedEffect {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("retried"))
  }
}
