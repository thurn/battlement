...
impl Component for Badge {
  fn render(&self) -> impl Render {
    reactant_core::host::Label::new(ls(self.text.clone()))
  }
}
...
impl Component for FailingBadge {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("fallible"))
  }
}
...
fn fake_client_applies_the_complete_rendered_session_hierarchy() {
  ...
  let first_handle = reactant.register_root(first.clone(), |game: &Game| {
    reactant_core::host::Label::new(ls(game.label.clone()))
  });
...
fn lifecycle_guards_and_baseline_entries_are_stable() {
  ...
  active.register_root(root.clone(), |_| {
    reactant_core::host::Label::new(ls("active"))
  });
  ...
  (
    (
      ...
      game
        .optional
        .get()
        .then(|| reactant_core::host::Label::new(ls("optional"))),
      (reactant_core::host::Label::new(ls("tuple")),),
      [
        reactant_core::host::Label::new(ls("array-a")),
        reactant_core::host::Label::new(ls("array-b")),
      ],
      vec![reactant_core::host::Label::new(ls("vector"))],
      Rc::new(reactant_core::host::Label::new(ls("rc"))),
    ),
    (
      Fragment::new((reactant_core::host::Label::new(ls("fragment")), ())),
      structural_branch(game.left_branch.get()),
      Node::new(reactant_core::host::Label::new(ls("node"))),
...
fn structural_branch(
  left: bool,
) -> Either<reactant_core::host::Label, Fragment<reactant_core::host::Label>> {
  if left {
    Either::left(reactant_core::host::Label::new(ls("either-left")))
  } else {
    Either::right(Fragment::new(reactant_core::host::Label::new(ls(
      "either-right",
    ))))
  }
}

fn rc_branch(left: bool) -> Either<Rc<reactant_core::host::Label>, reactant_core::host::Label> {
  if left {
    Either::left(Rc::new(reactant_core::host::Label::new(ls("rc-branch"))))
  } else {
    Either::right(reactant_core::host::Label::new(ls("rc-branch")))
  }
}

fn nested_node(nested: bool) -> Node {
  if nested {
    Node::new(Node::new(reactant_core::host::Label::new(ls(
      "nested-node",
    ))))
  } else {
    Node::new(reactant_core::host::Label::new(ls("nested-node")))
  }
}

fn wrapped_fragment(
  wrapped: bool,
) -> Either<Fragment<Rc<reactant_core::host::Label>>, Fragment<reactant_core::host::Label>> {
  if wrapped {
    Either::left(Fragment::new(Rc::new(reactant_core::host::Label::new(ls(
      "wrapped-fragment",
    )))))
  } else {
    Either::right(Fragment::new(reactant_core::host::Label::new(ls(
