...
impl Component for ViewportFixture {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls(format!("generation {:?}", snapshot.generation)))
  }
}
...
impl Component for ElementFixture {
  fn render(&self) -> impl Render {
    ...
    self.snapshots.borrow_mut().push(snapshot.clone());
    reactant_core::host::Label::new(ls(format!("status {:?}", snapshot.measurements.status)))
      .name("target")
      .key(self.key)
...
impl Component for ShapeFixture {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("shape"))
  }
}
...
impl Component for InvalidGeometryRead {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("invalid")).element_ref(element_ref)
  }
}
...
impl Component for RetryFixture {
  fn render(&self) -> impl Render {
    ...
    (
      reactant_core::host::Label::new(ls("retry target"))
        .key(self.host_key)
        .element_ref(element_ref),
      ErrorBoundary::new(|_: &RenderError| reactant_core::host::Label::new(ls("fallback")))
        ...
        .child(if self.fail {
          ...
          Ok(reactant_core::host::Label::new(ls("primary")))
        }),
    )
  }
}
...
impl Component for TransitionFixture {
  fn render(&self) -> impl Render {
    ...
    (
      self
        .attach
        .then(|| reactant_core::host::Label::new(ls("attached")).element_ref(element_ref)),
      (!self.attach).then(|| reactant_core::host::Label::new(ls("detached"))),
    )
  }
}
