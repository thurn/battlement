...
fn propagation_view(_ledger: &Ledger) -> impl reactant_core::render::Render + use<> {
...
fn crossing_view(ledger: &Ledger) -> Result<impl reactant_core::render::Render + use<>, io::Error> {
  if ledger.fail_render {
    return Err(io::Error::other("render failed"));
  }
  let a = reactant_core::host::View::new()
    .name("a-parent")
    .child(
      reactant_core::host::View::new()
        .name("a-leaf")
  ...
  let b = reactant_core::host::View::new()
    .name("b-parent")
    .child(
      reactant_core::host::View::new()
        .name("b-leaf")
...
fn raw_crossing_view(_ledger: &Ledger) -> impl reactant_core::render::Render + use<> {
  reactant_core::host::View::new()
    .child(
      reactant_core::host::View::new()
        .name("raw-a")
