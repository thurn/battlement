...
impl Component for RefFixture {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::ButtonHost::new(ls("mutate ref")).on_click(move |_game: &mut Game| {
...
impl Component for InvalidRefAccess {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("ref"))
  }
}
...
impl Component for RequiredConsumer {
  fn render(&self) -> impl Render {
    reactant_core::host::Label::new(ls(hooks::use_required_context::<Required>().0))
  }
}
...
impl Component for NestedRuntime {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls(text))
  }
}
...
fn ref_and_context_hooks_enforce_positional_kind_and_identity() {
  ...
  impl Component for VariableHook {
    fn render(&self) -> impl Render {
      ...
      reactant_core::host::Label::new(ls("hook"))
    }
  }
  ...
  impl Component for VariableContext {
    fn render(&self) -> impl Render {
      ...
      reactant_core::host::Label::new(ls(value))
    }
  }
