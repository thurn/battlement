...
struct LocalizedFixture {
  mounts: Rc<Cell<u32>>,
  portal: reactant_core::portal::PortalTarget,
}
...
impl reactant_core::executor::Spawner for IdleSpawner {
  fn spawn(
    &self,
    _future: reactant_core::executor::BoxFuture<'static, ()>,
  ...
  View::new()
    ...
    .child((
      ...
      TabView::new()
        ...
        .child(reactant_core::host::TabHost::new(message()).child(Label::new(message()))),
      Label::new(message()).semantic(
        SemanticProps::new(SemanticRole::StaticText)
          .name(SemanticName::text(message()))
          .description(SemanticDescription::text(message())),
