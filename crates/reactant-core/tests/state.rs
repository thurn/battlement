...
impl Component for Counter {
  fn render(&self) -> impl Render {
    ...
    (
      reactant_core::host::ButtonHost::new(ls("Queue updates")).on_click(
        move |_game: &mut Game| {
      ...
      reactant_core::host::Label::new(ls(format!("Count {count}"))),
    )
  }
}
...
impl Component for KeyedCounter {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls(format!("{}:{count}", self.id)))
  }
}
...
impl Component for RenderPhaseCounter {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls(format!("Retried {count}")))
  }
}
...
impl Component for Overflow {
  fn render(&self) -> impl Render {
    let (count, setter) = use_state(0);
    setter.update(|value| value + 1);
    reactant_core::host::Label::new(ls(count.to_string()))
  }
}
...
impl Component for CallbackCounter {
  fn render(&self) -> impl Render {
    ...
    (
      reactant_core::host::ButtonHost::new(ls("Increment"))
        .on_click(setter.update_callback(|value| value + 1)),
      reactant_core::host::ButtonHost::new(ls("Replace"))
...
impl Component for VariableHooks {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("stable"))
  }
}
...
impl Component for BadInitializer {
  fn render(&self) -> impl Render {
    ...
    reactant_core::host::Label::new(ls("invalid"))
  }
}
