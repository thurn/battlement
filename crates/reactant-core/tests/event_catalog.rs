...
fn typed_event_builders_forward_stored_callbacks() {
  ...
  let _host = reactant_core::host::View::new().on_key_down_event_callback(callback);
}
...
fn common_builder_catalog() {
  let value = reactant_core::host::View::new();
...
fn control_specific_builder_catalog_preserves_exact_host_types() {
  let text = reactant_core::host::TextField::new();
  let text = target_only!(text, on_input, on_input_event_with_model, TextInputEvent);
  ...
  let text = text
    ...
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<String>| {});

  let scroll = reactant_core::host::ScrollView::new();
  ...
  let tabs = reactant_core::host::TabView::new();
  ...
  let tabs = tabs
    .on_change(|_: &mut Ledger| {})
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<u32>| {});

  let scroller = reactant_core::host::Scroller::new()
  ...
  let slider = reactant_core::host::SliderHost::new()
    .on_value_changing(|_: &mut Ledger| {})
    .on_value_changing_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueChangingEvent>| {})
    .on_value_committed(|_: &mut Ledger| {})
    .on_value_committed_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueCommitEvent>| {})
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<f32>| {});
  let slider_int = reactant_core::host::SliderInt::new()
    .on_value_changing(|_: &mut Ledger| {})
    .on_value_changing_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueChangingEvent>| {})
    .on_value_committed(|_: &mut Ledger| {})
    .on_value_committed_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueCommitEvent>| {})
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<i32>| {});
  let min_max = reactant_core::host::MinMaxSlider::new()
    .on_value_changing(|_: &mut Ledger| {})
    .on_value_changing_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueChangingEvent>| {})
    .on_value_committed(|_: &mut Ledger| {})
    .on_value_committed_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueCommitEvent>| {})
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<F32Range>| {});
  let toggle = reactant_core::host::ToggleHost::new()
    .on_value_committed(|_: &mut Ledger| {})
    .on_value_committed_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueCommitEvent>| {})
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<bool>| {});
  let radio = reactant_core::host::RadioButton::new()
    .on_value_committed(|_: &mut Ledger| {})
    .on_value_committed_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueCommitEvent>| {})
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<bool>| {});
  let radio_group = reactant_core::host::RadioButtonGroup::new()
    .on_value_committed(|_: &mut Ledger| {})
    .on_value_committed_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueCommitEvent>| {})
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<Option<u32>>| {});
  let toggle_group = reactant_core::host::ToggleButtonGroup::new()
    .on_value_committed(|_: &mut Ledger| {})
    .on_value_committed_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueCommitEvent>| {})
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<Vec<u32>>| {});
  let dropdown = reactant_core::host::DropdownField::new()
    .on_value_committed(|_: &mut Ledger| {})
    .on_value_committed_event_with_model(|_: &mut Ledger, _: ReactantEvent<ValueCommitEvent>| {})
    .on_change_event_with_model(|_: &mut Ledger, _: ReactantEvent<Choice>| {});
...
fn typed_controls(ledger: &Ledger) -> impl Render + use<> {
  ...
  (
    ...
    reactant_core::host::DropdownField::new()
      .name("dropdown")
      .on_change_event_with_model(|game: &mut Ledger, event: ReactantEvent<Choice>| {
    ...
    reactant_core::host::TabView::new()
      .name("tabs")
      .on_change_event_with_model(|game: &mut Ledger, event: ReactantEvent<u32>| {
