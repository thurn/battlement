...
fn facade_descriptor(element: &UiElement) -> TypeId {
  match element {
    ...
    UiElement::Toggle(_) => TypeId::of::<ToggleHost>(),
    ...
    UiElement::Button(_) => TypeId::of::<ButtonHost>(),
    ...
    UiElement::Slider(_) => TypeId::of::<SliderHost>(),
    ...
    UiElement::Tab(_) => TypeId::of::<TabHost>(),
    UiElement::TabView(_) => TypeId::of::<TabView>(),
    UiElement::Image(_) => TypeId::of::<ImageHost>(),
  }
}
