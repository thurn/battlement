...
impl CommandBody {
  /// Payload-free command kind for diagnostics.
  pub fn kind_name(&self) -> &'static str {
    match self {
      Self::ApplicationOpenUrl(..) => "ApplicationOpenUrl",
      Self::ApplicationSetFramePacing(..) => "ApplicationSetFramePacing",
      Self::ApplicationDisplay(..) => "ApplicationDisplay",
      Self::Diagnostics(..) => "Diagnostics",
      Self::AssetsReplaceSet(..) => "AssetsReplaceSet",
      Self::SceneLoad(..) => "SceneLoad",
      Self::SceneUnload(..) => "SceneUnload",
      Self::SceneSetPrimary(..) => "SceneSetPrimary",
      Self::ObjectCreate(..) => "ObjectCreate",
      Self::BoxHitRegionSetGeometry(..) => "BoxHitRegionSetGeometry",
      Self::ObjectDestroy(..) => "ObjectDestroy",
      Self::ObjectSetActive(..) => "ObjectSetActive",
      Self::ObjectSetRenderOrder(..) => "ObjectSetRenderOrder",
      Self::RendererSetInstances(..) => "RendererSetInstances",
      Self::ObjectReparent(..) => "ObjectReparent",
      Self::TransformSetLocalPosition(..) => "TransformSetLocalPosition",
      Self::TransformSetWorldPosition(..) => "TransformSetWorldPosition",
      Self::TransformTweenLocalPosition(..) => "TransformTweenLocalPosition",
      Self::TransformTweenWorldPosition(..) => "TransformTweenWorldPosition",
      Self::TransformSetLocalRotation(..) => "TransformSetLocalRotation",
      Self::TransformSetWorldRotation(..) => "TransformSetWorldRotation",
      Self::TransformTweenLocalRotation(..) => "TransformTweenLocalRotation",
      Self::TransformTweenWorldRotation(..) => "TransformTweenWorldRotation",
      Self::TransformSetLocalScale(..) => "TransformSetLocalScale",
      Self::TransformTweenLocalScale(..) => "TransformTweenLocalScale",
      Self::RendererSetMaterial(..) => "RendererSetMaterial",
      Self::CameraSetEnabled(..) => "CameraSetEnabled",
      Self::CameraSetPerspective(..) => "CameraSetPerspective",
      Self::CameraTweenFieldOfView(..) => "CameraTweenFieldOfView",
      Self::CameraSetOrthographic(..) => "CameraSetOrthographic",
      Self::CameraTweenOrthographicSize(..) => "CameraTweenOrthographicSize",
      Self::CameraSetClipping(..) => "CameraSetClipping",
      Self::CameraSetClear(..) => "CameraSetClear",
      Self::LightSetEnabled(..) => "LightSetEnabled",
      Self::LightSetType(..) => "LightSetType",
      Self::LightSetColor(..) => "LightSetColor",
      Self::LightTweenColor(..) => "LightTweenColor",
      Self::LightSetIntensity(..) => "LightSetIntensity",
      Self::LightTweenIntensity(..) => "LightTweenIntensity",
      Self::LightSetRange(..) => "LightSetRange",
      Self::LightSetSpotAngle(..) => "LightSetSpotAngle",
      Self::LightSetShadows(..) => "LightSetShadows",
      Self::ImageSetTexture(..) => "ImageSetTexture",
      Self::ImageSetSize(..) => "ImageSetSize",
      Self::ImageSetFit(..) => "ImageSetFit",
      Self::ImageSetTint(..) => "ImageSetTint",
      Self::ImageTweenTint(..) => "ImageTweenTint",
      Self::ImageSetOpacity(..) => "ImageSetOpacity",
      Self::ImageTweenOpacity(..) => "ImageTweenOpacity",
      Self::ImageSetFaceCamera(..) => "ImageSetFaceCamera",
      Self::TextSetContent(..) => "TextSetContent",
      Self::TextSetFont(..) => "TextSetFont",
      Self::TextSetSize(..) => "TextSetSize",
      Self::TextTweenSize(..) => "TextTweenSize",
      Self::TextSetColor(..) => "TextSetColor",
      Self::TextTweenColor(..) => "TextTweenColor",
      Self::TextSetAlignment(..) => "TextSetAlignment",
      Self::TextSetWrapping(..) => "TextSetWrapping",
      Self::TextSetRichText(..) => "TextSetRichText",
      Self::TextSetFaceCamera(..) => "TextSetFaceCamera",
      Self::AnimatorPlay(..) => "AnimatorPlay",
      Self::AnimatorCrossFade(..) => "AnimatorCrossFade",
      Self::AnimatorSetBool(..) => "AnimatorSetBool",
      Self::AnimatorSetInt(..) => "AnimatorSetInt",
      Self::AnimatorSetFloat(..) => "AnimatorSetFloat",
      Self::AnimatorSetTrigger(..) => "AnimatorSetTrigger",
      Self::AnimatorSetSpeed(..) => "AnimatorSetSpeed",
      Self::ParticlePlay(..) => "ParticlePlay",
      Self::ParticleStop(..) => "ParticleStop",
      Self::ParticleSpawn(..) => "ParticleSpawn",
      Self::AudioPlay(..) => "AudioPlay",
      Self::AudioSetMix(..) => "AudioSetMix",
      Self::AudioStop(..) => "AudioStop",
      Self::AudioPause(..) => "AudioPause",
      Self::AudioResume(..) => "AudioResume",
      Self::AudioSeek(..) => "AudioSeek",
      Self::AudioSetBuffering(..) => "AudioSetBuffering",
      Self::AudioReplace(..) => "AudioReplace",
      Self::AudioSetVolume(..) => "AudioSetVolume",
      Self::AudioTweenVolume(..) => "AudioTweenVolume",
      Self::TimeWait(..) => "TimeWait",
      Self::OperationCancel(..) => "OperationCancel",
      Self::InputSetEnabled(..) => "InputSetEnabled",
      Self::InputSetCamera(..) => "InputSetCamera",
      Self::InputSetPointerEvents(..) => "InputSetPointerEvents",
      Self::InputSetWorldPointer(..) => "InputSetWorldPointer",
      Self::InputSetGlobalKeys(..) => "InputSetGlobalKeys",
      Self::InputSetController(..) => "InputSetController",
      Self::InputCapture(..) => "InputCapture",
      Self::ControllerVibrate(..) => "ControllerVibrate",
      Self::DebugUi(..) => "DebugUi",
      Self::VisualElementCreate(..) => "VisualElementCreate",
      Self::VisualElementUpdate(..) => "VisualElementUpdate",
      Self::VisualElementDestroy(..) => "VisualElementDestroy",
      Self::VisualElementPerformAction(..) => "VisualElementPerformAction",
      Self::MotionValue(..) => "MotionValue",
      Self::MotionSetWorldDescriptor(..) => "MotionSetWorldDescriptor",
      Self::MotionValuePlayback(..) => "MotionValuePlayback",
      Self::MotionPlayback(..) => "MotionPlayback",
      Self::MotionControlledClock(..) => "MotionControlledClock",
      Self::MotionControl(..) => "MotionControl",
      Self::MotionScope(..) => "MotionScope",
      Self::MotionDragControl(..) => "MotionDragControl",
      Self::GeometryObservationUpdate(..) => "GeometryObservationUpdate",
