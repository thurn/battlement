...
const RESPONSE: &[u8] = include_bytes!(
    "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-response.msgpack"
);
const CUSTOM_RESPONSE: &[u8] = include_bytes!(
    "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-custom-response.msgpack"
);
const RUST_RESPONSE: &[u8] =
    include_bytes!("../../../Packages/com.battlement.client/Tests/Fixtures/rust-response.msgpack");
const RUST_CUSTOM_RESPONSE: &[u8] = include_bytes!(
    "../../../Packages/com.battlement.client/Tests/Fixtures/rust-custom-response.msgpack"
);
const ACTIONS: [&[u8]; 9] = [
    include_bytes!(
    ...
    include_bytes!(
        "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-pointer-exit.msgpack"
    ),
    include_bytes!(
        "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-pointer-down.msgpack"
    ),
    include_bytes!(
        "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-pointer-up.msgpack"
    ),
    include_bytes!(
        "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-pointer-click.msgpack"
    ),
    include_bytes!(
        "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-drag-start.msgpack"
    ),
    include_bytes!(
        "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-drag-end.msgpack"
    ),
    include_bytes!(
        "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-key-down.msgpack"
    ),
    include_bytes!(
        "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-key-up.msgpack"
    ),
];
const CUSTOM_ACTION: &[u8] = include_bytes!(
    "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-custom.msgpack"
);
const BATCH_FAILED: &[u8] = include_bytes!(
    "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-batch-failed.msgpack"
);
const OPERATION_FAILED: &[u8] = include_bytes!(
    "../../../Packages/com.battlement.client/Tests/Fixtures/csharp-client-operation-failed.msgpack"
);
