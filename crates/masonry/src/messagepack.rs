//! MessagePack encoding for Masonry protocol values.
...
/// Encodes one value using Masonry's compact MessagePack representation.
...
/// Decodes one value from Masonry's compact MessagePack representation.
