...
impl<E> FakeClient<E>
where
    E: masonry_native::Engine<Command = Command>,
{
    pub(crate) fn execute_command(
        &mut self,
        command: Command,
        batch_id: masonry::BatchId,
        group_index: usize,
        command_index: usize,
    ) {
    ...
    fn execute_body(&mut self, body: &CommandBody, command_id: masonry::CommandId) {
        match body {
            ...
            CommandBody::CameraSetPerspective(value) => {
                ...
                camera.projection = masonry::CameraProjection::Perspective;
            ...
            CommandBody::CameraSetOrthographic(value) => {
                let camera = self.world.camera_mut(value.payload.object_id);
                camera.projection = masonry::CameraProjection::Orthographic;
            ...
            CommandBody::ParticleSpawn(value) => {
                ...
                if let masonry::ParticleSpawnLocation::GameObject(object_id) = value.location {
    ...
    fn set_material(&mut self, value: &PropertyCommand<masonry::SetMaterialPayload>) {
        self.require_prepared(
    ...
    fn set_particles(&mut self, object_id: masonry::ObjectId, playing: bool) {
