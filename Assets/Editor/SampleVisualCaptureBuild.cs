    ...
    public static class SampleVisualCaptureBuild
    {
        ...
        private static string AddScenario(string scenePath, string scenarioName)
        {
            ...
            Type scenarioType = scenarioName switch
            {
                ...
                "reactant-refs-initial" => typeof(ReactantRefsInitialCaptureScenario),
                "reactant-refs-active" => typeof(ReactantRefsActiveCaptureScenario),
                "reactant-refs-restored" => typeof(ReactantRefsRestoredCaptureScenario),
