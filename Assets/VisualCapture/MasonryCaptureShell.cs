...
namespace Masonry.VisualCapture
{
    ...
    public sealed class MasonryCaptureShell : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private string title = "Masonry visual evidence";
        ...
        private void Awake()
        {
            ...
            )
            {
                throw new InvalidOperationException(
                    "MasonryCaptureShell is missing an authored camera, light, or material."
                );
            }
