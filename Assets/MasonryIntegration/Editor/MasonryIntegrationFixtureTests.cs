...
namespace Masonry.Integration.EditorTests
{
    [Parallelizable(ParallelScope.None)]
    public sealed class MasonryIntegrationFixtureTests : InputTestFixture
    {
        private Mouse? mouse;
        ...
        public IEnumerator NativeSnapshotLoadsRealContentAndReturnsClickCommand()
        {
            EditorSceneManager.OpenScene(
                MasonryIntegrationFixture.BootstrapScenePath,
                OpenSceneMode.Single
            );
            yield return new EnterPlayMode();
            mouse = InputSystem.AddDevice<Mouse>("Masonry Integration Fixture Mouse");
            MasonryIntegrationFixture fixture = UnityEngine
                .Object.FindObjectsByType<MasonryIntegrationFixture>()
                .Single();
        ...
        private void QueueMouse(
            MasonryIntegrationFixture fixture,
