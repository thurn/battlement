...
| World text and relative ordering | [text props](../../crates/reactant/src/world_text.rs), [group ordering](../../crates/reactant/src/world.rs), [ordering protocol](../../crates/battlement/src/render_order.rs), [Unity ordering](../../Packages/com.battlement.client/Runtime/Host/BattlementRenderOrder.cs), [public scenarios](../../crates/reactant-testing/tests/world_text.rs), [native fixture](../../samples/reactant/rules/src/world_text_proof.rs) |
| Independent hit geometry and local points | [box props](../../crates/reactant/src/world_hit_region.rs), [typed targets](../../crates/reactant-core/src/local_point.rs), [native identity leases](../../crates/reactant-core/src/native_identity_lease.rs), [Unity collider](../../Packages/com.battlement.client/Runtime/Host/BattlementBoxHitRegion.cs), [public scenarios](../../crates/reactant-testing/tests/world_hit_regions.rs), [native fixture](../../samples/reactant/rules/src/world_hit_proof.rs) |
| Typed renderer material instances | `crates/battlement/src/material.rs`, `material_dependencies.rs`; `crates/reactant/src/world_object.rs`; `Packages/com.battlement.client/Runtime/Host/BattlementMaterialInstances.cs`, `BattlementPreparedAssets.cs` |
| Typed world hosts and prepared geometry | [world.rs](../../crates/reactant/src/world.rs), [world_visuals.rs](../../crates/reactant/src/world_visuals.rs), [world_view.rs](../../crates/reactant/src/world_view.rs), [property commands](../../crates/reactant/src/world_properties.rs), [Unity mesh construction](../../Packages/com.battlement.client/Runtime/Host/BattlementMeshGeometry.cs), [public scenarios](../../crates/reactant-testing/tests/world_hosts.rs) |
| World rest-layout targets, movement, and measurement | [public types and component](../../crates/reactant/src/world_layout.rs), [builders](../../crates/reactant/src/world_layout_builders.rs), [Taffy and pure algorithms](../../crates/reactant/src/world_layout_algorithms.rs), [shared imperative ownership](../../Packages/com.battlement.client/Runtime/UI/BattlementMotionOwnership.cs), [geometry cache](../../crates/reactant-core/src/geometry_runtime.rs), [native rest-bounds sampler](../../Packages/com.battlement.client/Runtime/Host/BattlementWorldRestBoundsGeometry.cs), [public scenarios](../../crates/reactant-testing/tests/world_layout.rs), [native draw-reflow fixture](../../samples/reactant/rules/src/draw_reflow_proof.rs) |
...
| Input and focus | [event_dispatch.rs](../../crates/reactant-core/src/event_dispatch.rs), [focus.rs](../../crates/reactant-core/src/focus.rs), [controlled native source](../../Packages/com.battlement.client/Runtime/Host/BattlementControlledPointerSource.cs), [shared world routing](../../Packages/com.battlement.client/Runtime/Host/BattlementPointerInput.cs), [UI Toolkit routing](../../Packages/com.battlement.client/Runtime/UI/BattlementUiControlledPointerInput.cs), [Ditto execution](../../Packages/com.battlement.client/Runtime/Host/Ditto/DittoScenarioExecutor.cs) |
...
| Binary schemas and generation | [schemas](../../schemas/flatbuffers), [generator](../../scripts/generate_flatbuffers.py), [toolchain contract](../../schemas/flatbuffers-toolchain.json), [wire manifest](../../contracts/wire-contract.json), [exported digest checks](../../crates/battlement-native/tests/exported_abi_tests.rs) |
| Verified transport, borrowed events, and direct writers | [FlatBuffers facade](../../crates/battlement-flatbuffers/src/lib.rs), [app encoding/admission](../../crates/reactant-core/src/app_output.rs) |
| Buffer ownership and admission | [native allocation budget](../../crates/battlement-native/src/response_budget.rs), [native handles](../../crates/battlement-native/src/handles.rs), [Unity transport](../../Packages/com.battlement.client/Runtime/Host/Native/BattlementNativeTransport.cs), [response stream](../../Packages/com.battlement.client/Runtime/Host/BattlementResponseStream.cs) |
...
| Shared UI/world Motion | [BattlementMotionWorld.cs](../../Packages/com.battlement.client/Runtime/UI/BattlementMotionWorld.cs), [BattlementLayoutProjection.cs](../../Packages/com.battlement.client/Runtime/UI/BattlementLayoutProjection.cs), [BattlementWorldLayoutProjection.cs](../../Packages/com.battlement.client/Runtime/Host/BattlementWorldLayoutProjection.cs), [BattlementWorldMotion.cs](../../Packages/com.battlement.client/Runtime/Host/BattlementWorldMotion.cs), [BattlementWorldMotionTarget.cs](../../Packages/com.battlement.client/Runtime/Host/BattlementWorldMotionTarget.cs), [layout.rs](../../crates/reactant-core/src/layout.rs), [motion.rs](../../crates/battlement-fake/src/motion.rs), [public identity scenarios](../../crates/reactant-testing/tests/presentation_identity.rs), [native identity fixture](../../samples/reactant/rules/src/identity_proof.rs) |
...
| Typed requests and response validation | [response.rs](../../crates/reactant-rules/src/response.rs), [public prompt scenarios](../../crates/reactant-testing/tests/prompts.rs), [queued input scenarios](../../crates/reactant-testing/tests/queued_input.rs) |
...
| Generic library-only Ditto | [lib.rs](../../crates/battlement-ditto/src/lib.rs), [cli.rs](../../crates/battlement-ditto/src/cli.rs), [rt integration](../../crates/rt/src/ditto.rs) |
