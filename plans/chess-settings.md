...
The native graph uses the dependencies listed here plus the approval gate on
every executable package. Task IDs are stable planning identifiers; bead IDs are
recorded in the final index. Independent packages may be scheduled independently
...
completes only when S01–S23 have accepted evidence; S18 alone allows the documented
best-effort exception. Missing Windows/iOS hardware leaves qualification open.

## Native bead index

Epic: **hv-ou5**. Approval decision: **hv-ou5.1**.

| Package | Bead | Blocking work packages (approval is also required) |
| --- | --- | --- |
| S01 | `hv-ou5.2` | None |
| S02 | `hv-ou5.3` | S01 |
| S03 | `hv-ou5.4` | None |
| S04 | `hv-ou5.5` | S01, S03 |
| S05 | `hv-ou5.6` | S04 |
| S06 | `hv-ou5.7` | S05 |
| S07 | `hv-ou5.8` | S03 |
| S08 | `hv-ou5.9` | S04, S07 |
| S09 | `hv-ou5.10` | S04 |
| S10 | `hv-ou5.11` | S04, S09 |
| S11 | `hv-ou5.12` | None |
| S12 | `hv-ou5.13` | S04, S11 |
| S13 | `hv-ou5.14` | S03 |
| S14 | `hv-ou5.15` | S04, S13 |
| S15 | `hv-ou5.16` | S01, S03 |
| S16 | `hv-ou5.17` | S03 |
| S17 | `hv-ou5.18` | S04, S15, S16 |
| S18 | `hv-ou5.19` | S04 |
| S19 | `hv-ou5.20` | None |
| S20 | `hv-ou5.21` | S06, S08, S10, S12, S14, S17, S18 |
| S21 | `hv-ou5.22` | S20 |
| S22 | `hv-ou5.23` | S02, S20 |
| S23 | `hv-ou5.24` | S19, S20 |
