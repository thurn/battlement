...
def _ci_run(run: Span, spans: list[Span]) -> dict[str, Any]:
    ...
    return {
        ...
        "cpu_user_ms": run.attributes.get("cpu_user_ms"),
        "cpu_system_ms": run.attributes.get("cpu_system_ms"),
        "max_rss": run.attributes.get("max_rss"),
        "cpu_scope": run.attributes.get("cpu_scope"),
        "status": run.status,
