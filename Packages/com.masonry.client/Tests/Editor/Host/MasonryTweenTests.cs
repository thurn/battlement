...
{
    public sealed class MasonryTweenTests
    {
        [Test]
        ...
        private static (SessionId, ObjectId, Transform) ConnectObject(MasonryTestHarness harness)
        {
        ...
        private static MasonryGameObject GameObject(ObjectId id) =>
            new(
                id,
        ...
        private static void Submit(MasonryTestHarness harness, SessionId session, Batch batch)
        {
        ...
        {
            MasonryIdentity? identity = Object
        ...
        private static ClientMessage<CoreErrorCode, byte>? TryDecode(byte[] bytes)
        {
            try
            {
                return MasonryMessagePack.DeserializeClientMessage(
                    bytes,
