...
{
    public sealed class MasonryTextCameraLightTests
    {
        [Test]
        ...
        public void InvalidComponentRangesStopTheSession(string invalidCase)
        {
            ...
            MasonryGameObject invalid = InvalidObject(invalidCase, fontAddress);
        ...
        {
            using MasonryTestHarness missingFontHarness = MasonryTestHarness.Create();
            ...
            using MasonryTestHarness disabledCameraHarness = MasonryTestHarness.Create();
            var cameraId = NewObjectId();
        ...
        private static IEnumerable<MasonryGameObject> TextObjects(
            ObjectId[] ids,
            FontAddress address
        )
        {
        ...
        private static IEnumerable<MasonryGameObject> CameraObjects(
            ObjectId inputId,
            ObjectId[] ids
        )
        {
        ...
        private static IEnumerable<MasonryGameObject> LightObjects(ObjectId[] ids)
        {
        ...
        private static MasonryGameObject InvalidObject(string invalidCase, FontAddress font) =>
            invalidCase switch
            {
                "text-size" => Describe(
                    NewObjectId(),
