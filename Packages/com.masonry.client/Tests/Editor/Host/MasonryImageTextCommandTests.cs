...
{
    public sealed class MasonryImageTextCommandTests
    {
        [Test]
        ...
        private static MasonryGameObject Image(ObjectId id, TextureAddress address) =>
            Describe(
                id,
        ...
        private static MasonryGameObject Text(ObjectId id, FontAddress address) =>
            Describe(
                id,
        ...
        private static MasonryGameObject CameraObject(ObjectId id) =>
            new(
                id,
