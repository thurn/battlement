...
{
    public sealed class MasonryCameraLightCommandTests
    {
        [Test]
        ...
        private static MasonryGameObject CameraObject(ObjectId id, Vector3? position = null) =>
            new(
                id,
        ...
        private static MasonryGameObject LightObject(ObjectId id) =>
            new(
                id,
        ...
        private static MasonryGameObject ImageObject(ObjectId id, TextureAddress address) =>
            new(
                id,
