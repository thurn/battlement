    ...
    internal static class MessagePackFixtureData
    {
        ...
        internal static IReadOnlyDictionary<string, byte[]> ClientMessages()
        {
            ...
            byte[] EncodeAction(ActionBody body) =>
                MasonryMessagePack.SerializeClientMessage(
            ...
            return new Dictionary<string, byte[]>
            {
                ...
                ["csharp-client-custom.msgpack"] = MasonryMessagePack.SerializeClientMessage(
                ...
                ["csharp-client-batch-failed.msgpack"] = MasonryMessagePack.SerializeClientMessage(
