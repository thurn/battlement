...
namespace Battlement
{
    ...
    public sealed record UiStyle(
        ...
        Prop<UiStyleValue<UiRotate>> Rotate = default,
        Prop<UiStyleValue<UiScale>> Scale = default,
        Prop<UiStyleValue<UiTextOverflow>> TextOverflow = default,
        Prop<UiStyleValue<UiTextShadow>> TextShadow = default,
        Prop<UiStyleValue<UiLengthOrAuto>> Top = default,
        Prop<UiStyleValue<UiTransformOrigin>> TransformOrigin = default,
        Prop<UiStyleValue<IReadOnlyList<float>>> TransitionDelay = default,
        Prop<UiStyleValue<IReadOnlyList<float>>> TransitionDuration = default,
        Prop<UiStyleValue<IReadOnlyList<UiTransitionProperty>>> TransitionProperty = default,
        Prop<UiStyleValue<IReadOnlyList<UiEasingFunction>>> TransitionTimingFunction = default,
        Prop<UiStyleValue<UiTranslate>> Translate = default,
        Prop<UiStyleValue<Color>> UnityBackgroundImageTintColor = default,
        Prop<UiStyleValue<UiEditorTextRenderingMode>> UnityEditorTextRenderingMode = default,
        Prop<UiStyleValue<UiFontAddress>> UnityFontDefinition = default,
        Prop<UiStyleValue<UiFontStyle>> UnityFontStyleAndWeight = default,
        Prop<UiStyleValue<MaterialAddress>> UnityMaterial = default,
        Prop<UiStyleValue<UiOverflowClipBox>> UnityOverflowClipBox = default,
        Prop<UiStyleValue<UiLength>> UnityParagraphSpacing = default,
        ...
        Prop<UiStyleValue<UiTextAnchor>> UnityTextAlign = default,
        Prop<UiStyleValue<UiTextAutoSize>> UnityTextAutoSize = default,
        Prop<UiStyleValue<UiTextGenerator>> UnityTextGenerator = default,
        Prop<UiStyleValue<Color>> UnityTextOutlineColor = default,
        Prop<UiStyleValue<float>> UnityTextOutlineWidth = default,
        Prop<UiStyleValue<UiTextOverflowPosition>> UnityTextOverflowPosition = default,
        Prop<UiStyleValue<UiVisibility>> Visibility = default,
        Prop<UiStyleValue<UiWhiteSpace>> WhiteSpace = default,
        Prop<UiStyleValue<UiLengthOrAuto>> Width = default,
        Prop<UiStyleValue<UiLength>> WordSpacing = default
    )
    {
