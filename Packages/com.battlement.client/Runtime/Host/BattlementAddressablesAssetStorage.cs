...
namespace Battlement
{
    ...
    public sealed class BattlementAddressablesAssetStorage : IBattlementAssetStorage
    {
        ...
        public void Dispose()
        {
            ...
            foreach (IBattlementAssetHandle handle in handles.ToArray())
            {
                handle.Dispose();
            }
            ...
            where T : UnityEngine.Object
        {
            ...
            public AssetHandle(PreparedAsset asset, Action<IBattlementAssetHandle> onDispose)
            {
                Asset = asset;
            ...
            public Exception? Error
            {
                get
                {
                    ...
                    {
                        error = new BattlementAssetException(
                            CoreErrorCode.UnknownAsset,
        ...
        private sealed class SceneHandle : IBattlementAssetHandle
        {
            private readonly Action<IBattlementAssetHandle> onDispose;
            private AsyncOperationHandle<IList<IResourceLocation>> locations;
            ...
            public SceneHandle(PreparedAsset.Scene asset, Action<IBattlementAssetHandle> onDispose)
            {
                Asset = asset;
                this.onDispose = onDispose;
        ...
        private sealed class AddressableSceneHandle : IBattlementSceneHandle
        {
            private readonly IBattlementAssetLease lease;
            private readonly Action<IBattlementSceneHandle> onDispose;
            ...
            public AddressableSceneHandle(
                IBattlementAssetLease sceneAsset,
                Action<IBattlementSceneHandle> onDispose
            )
            {
                lease = Preconditions.CheckNotNull(sceneAsset, nameof(sceneAsset));
                Asset =
