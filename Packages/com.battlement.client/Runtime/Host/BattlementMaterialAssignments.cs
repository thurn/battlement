...
namespace Battlement
{
    ...
    internal sealed class BattlementMaterialAssignments : MonoBehaviour, IBattlementOwnedResource
    {
        ...
        {
            public MaterialLease(string address, Material material, IBattlementAssetLease lease)
            {
                Address = address;
                Material = material;
                Lease = lease;
            ...
            public IBattlementAssetLease Lease { get; }
