...
{
    internal readonly struct BattlementPointerSample
    {
        public BattlementPointerSample(
            Vector2 position,
        ...
        public static BattlementPointerSample Absent(Vector2 position) =>
            new(position, new HashSet<PointerButton>(), false, false);
    }

    internal static class BattlementPointerDevices
    {
        public static SortedDictionary<int, BattlementPointerSample> Read(
        ...
        )
        {
            ...
            if (Mouse.current is Mouse mouse)
            {
                ...
                samples[0] = new BattlementPointerSample(
        ...
        )
        {
            foreach (TouchControl touch in touchscreen.touches)
            {
                ...
                samples[id] = new BattlementPointerSample(
