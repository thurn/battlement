    ...
    internal static partial class BattlementFlatBufferMaterializer
    {
        private sealed partial class UiProperties
        {
            ...
            )
            {
                ...
                for (int index = 0; index < length; index++)
                {
                    ...
                    result[index] = new MotionPropertyValue(
                        (MotionProperty)(ushort)item.Property,
                        BattlementFlatBufferMaterializer.MotionValue(item)
                    );
                }
                return result;
            }
            ...
            private static CssAnimationDescriptor CssAnimation(Wire.CssAnimationDescriptor value)
            {
                ...
                for (int index = 0; index < tracks.Length; index++)
                {
                    ...
                    for (int item = 0; item < values.Length; item++)
                        values[item] = BattlementFlatBufferMaterializer.MotionValue(
            ...
            )
            {
                ...
                for (int index = 0; index < length; index++)
                    result[index] = BattlementFlatBufferMaterializer.MotionValue(
