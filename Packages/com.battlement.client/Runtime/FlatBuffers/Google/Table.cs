...
namespace Google.FlatBuffers
{
    ...
    public struct Table
    {
        ...
        public Span<T> __vector_as_span<T>(int offset, int elementSize)
            where T : struct
        {
            if (!BitConverter.IsLittleEndian)
            {
                throw new NotSupportedException(
                    "Getting typed span on a Big Endian " + "system is not support"
                );
            }
            ...
            where T : struct
        {
            ...
            {
                throw new NotSupportedException(
                    "Getting typed arrays on a Big Endian " + "system is not support"
                );
            }
