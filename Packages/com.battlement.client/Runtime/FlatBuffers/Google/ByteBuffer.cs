    ...
    public class ByteBuffer
    {
            ...
            where T : struct
        {
            ...
            return MemoryMarshal
                .Cast<byte, T>(_buffer.ReadOnlySpan.Slice(posInBytes, lenInBytes))
                .ToArray();
#else
            ...
            where T : struct
        {
            ...
            MemoryMarshal
                .Cast<byte, T>(_buffer.ReadOnlySpan.Slice(posInBytes, lenInBytes))
                .CopyTo(arrayOfTs.AsSpan().Slice(padLeftInTs));
#else
            ...
            where T : struct
        {
            ...
            if (valueInTs * sizeOfT != valueInBytes)
            {
                throw new ArgumentException(
                    $"{valueInBytes} must be a multiple of SizeOf<{typeof(T).Name}>()={sizeOfT}"
                );
            }
#endif
            return valueInTs;
            ...
            where T : struct
        {
            ...
            {
                throw new ArgumentException(
                    "Cannot put an array of type " + typeof(T) + " into this buffer"
                );
            }
            ...
            else
            {
                throw new NotImplementedException(
                    "Big Endian Support not implemented yet " + "for putting typed arrays"
                );
