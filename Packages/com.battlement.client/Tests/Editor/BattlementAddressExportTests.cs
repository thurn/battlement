...
{
    public sealed class BattlementAddressExportTests
    {
        private const string Root = "Assets/BattlementAddressExportTests";
        ...
        public void CollectRejectsDuplicateAndMissingAddresses()
        {
            ...
            Assert.That(
                () => BattlementAddressExport.Collect(duplicates),
            ...
            Assert.That(
                () => BattlementAddressExport.Collect(missing),
            ...
            Assert.That(
                () => BattlementAddressExport.Collect(empty),
        ...
        public void CollectRejectsAddressesExcludedFromTheCatalog()
        {
            ...
            Assert.That(
                () => BattlementAddressExport.Collect(settings),
