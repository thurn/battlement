...
{
    public sealed class BattlementAudioCommandTests
    {
        [Test]
        ...
        private static AudioClip Clip(float seconds) =>
            AudioClip.Create("Battlement audio test", (int)(seconds * 1_000), 1, 1_000, false);

        private static BattlementGameObject Camera(ObjectId id) =>
            new(
                id,
        ...
        private static AudioSource[] Sources() =>
            Object
                ...
                .Where(value => value.gameObject.name == "Battlement Audio Source")
                .ToArray();
