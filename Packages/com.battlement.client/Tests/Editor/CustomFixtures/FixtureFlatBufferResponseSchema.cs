...
namespace Battlement.CustomFixtures
{
            ...
            IBattlementFlatBufferClientSchema
    {
        public const string ContractDigest =
            "5c6c5ecf617aca8c0b243721b70698637529c829532980b8fbc4704cfe5ec9c9";
        ...
        )
        {
            ...
            Wire.FlashPayload payload = command.Payload!.Value;
            return dispatcher.Launch(commandId, command.CommandType, isBlocking, payload, now);
        }
