...
namespace Battlement.Tests
{
    public sealed class BattlementUiAssetTests
    {
        ...
        [Test]
        public void TypographyFontIsLeasedAndRustTextWritesRemainSilent()
        {
            ...
            var lookup = new AssetLookup((preparedDefinition, fontAsset));
        ...
        [Test]
        public void TypographyFontTypeMismatchDoesNotApplyStyle()
        {
            Texture2D wrongDefinition = Track(new Texture2D(4, 4));
            var preparedDefinition = new PreparedAsset.UiFont(
                new UiFontAddress("ui/font-definition")
            );
            var lookup = new AssetLookup((preparedDefinition, wrongDefinition));
