...
{
    /// <summary>Exports explicit Addressables entries for Battlement's Rust generator.</summary>
    public static class BattlementAddressExport
    {
        private const string OutputVariable = "BATTLEMENT_ADDRESS_EXPORT_PATH";
        ...
        public static void Export()
        {
            ...
            Debug.Log($"BATTLEMENT_ADDRESS_EXPORT_OK:{entries.Count}");
        }
